...
this.supercellSymmetry = this.cr.asc.getXSymmetry().getFileSymmetry();
...
this.cr.addMoreUnitCellInfo("q" + (i + 1) + "=" + pt[0] + " " + pt[1] + " " + pt[2]);
...
JU.Logger.debug("setModulation iop = " + iop + " " + this.symmetry.getSpaceGroupXyzOriginal(iop, false) + " " + a.bsSymmetry);
