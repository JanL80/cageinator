...
this.name = null;
this.id = null;
Clazz.instantialize(this, arguments);}, J["export"], "_MayaExporter", J["export"].__CartesianExporter);
...
var rX = (Math.acos(this.tempV1.y / r) * 57.29577951308232);
if (this.tempV1.x < 0) rX += 180;
var rY = (Math.atan2(this.tempV1.x, this.tempV1.z) * 57.29577951308232);
