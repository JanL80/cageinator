...
c$.opTokenFor = Clazz.defineMethod(c$, "opTokenFor", 
function(tok){
switch (tok) {
case 1275069441:
case 1275069446:
...
var async = (this.vwr.async || file.startsWith("cache://") || args.length > 2 && args[args.length - 1].tok == 1073742335);
...
if (isUVW && Clazz.instanceOf(o,"JU.M4")) {
var m3 =  new JU.M3();
...
case 1814695966:
if (isDistance) {
bsSelected = this.vwr.ms.getAtoms(tok,  Clazz.newArray(-1, [null, Double.$valueOf(distance)]));
break out;
}isUnitCell = true;
break;
}
...
if (isDistance) {
isUnitCell = false;
bsSelected = this.vwr.ms.getAtoms(1814695966,  Clazz.newArray(-1, [null, Double.$valueOf(distance), Double.$valueOf(isBooleanFlag ? distance : -distance)]));
break out;
}} else {
isUnitCell = true;
}break;
...
var oabc = o;
var uc = this.vwr.getSymTemp().getUnitCell(oabc, false, null);
bsSelected = this.vwr.ms.getAtoms(tok,  Clazz.newArray(-1, [uc, isDistance ? Float.$valueOf(distance) : null]));
break;
}var plane = null;
var pt = null;
var pts1 = null;
