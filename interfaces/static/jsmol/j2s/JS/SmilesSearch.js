...
var justCheckBonding = (setAromatic && (isOpenNotStrict || Clazz.instanceOf(this.target.nodes[0],"JS.SmilesAtom")));
for (var i = 3; i <= max; i++) {
...
function(){
return (this.pattern0 == null ? Clazz.superCall(this, JS.SmilesSearch, "hashCode", []) : this.pattern0.hashCode());
});
/*if3*/;(function(){
var c$ = Clazz.decorateAsClass(function(){
