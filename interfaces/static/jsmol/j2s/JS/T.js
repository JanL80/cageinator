...
function(){
return "Token[" + JS.T.astrType[this.tok < 16 ? this.tok : 16] + "(" + (this.tok % 1000) + "/0x" + Integer.toHexString(this.tok) + ")" + ((this.intValue == 2147483647) ? "" : " intValue=" + this.intValue + "(0x" + Integer.toHexString(this.intValue) + ")") + ((this.value == null) ? "" : (typeof(this.value)=='string') ? " value=\"" + this.value + "\"" : Clazz.instanceOf(this.value,"JS.SV") ? " value=\"" + (this.value).asString() + "\"" : " value=" + this.value) + "]";
});
...
c$.tokenLength = JS.T.tv(268442113, 1275068435, "len3");
