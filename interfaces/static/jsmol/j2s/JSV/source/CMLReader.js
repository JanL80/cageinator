...
Clazz.load(["JSV.source.XMLReader"], "JSV.source.CMLReader", ["java.util.Vector", "JU.PT", "JSV.source.JDXSource"], function(){
var c$ = Clazz.decorateAsClass(function(){
this.specfound = false;
this.Ydelim = "";
this.peakData = null;
Clazz.instantialize(this, arguments);}, JSV.source, "CMLReader", JSV.source.XMLReader);
...
if ((this.strObFreq.charAt(0)).charCodeAt(0) > 47 && (this.strObFreq.charAt(0)).charCodeAt(0) < 58) this.obFreq = Double.parseDouble(this.strObFreq);
}}});
