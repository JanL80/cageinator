...
Clazz.load(["javajs.api.GenericBinaryDocument", "JU.BC"], "JU.BinaryDocument", ["java.io.DataInputStream"], function(){
...
this.out = null;
this.t8 = null;
Clazz.instantialize(this, arguments);}, JU, "BinaryDocument", JU.BC, javajs.api.GenericBinaryDocument);
...
var n;
{
if (this.stream.readDIS) {
n = this.stream.readDIS(b, off, len);
} else {
n = this.stream.read(b, off, len);
}
}m += n;
...
Clazz.overrideMethod(c$, "setBigEndian", 
function(b){
this.isBigEndian = b;
}, "~B");
});
