...
Clazz.load(["JU.P3", "$.V3"], "JU.BoxInfo", ["java.util.Hashtable", "JU.Measure", "$.P4", "JU.Point3fi"], function(){
...
this.margin = 0;
Clazz.instantialize(this, arguments);}, JU, "BoxInfo", null);
...
c$.getBoxFacesFromOABC = Clazz.defineMethod(c$, "getBoxFacesFromOABC", 
function(oabc){
...
c$.bbcageTickEdges =  Clazz.newCharArray(-1, ['z', '\0', '\0', 'y', 'x', '\0', '\0', '\0', '\0', '\0', '\0', '\0']);
c$.uccageTickEdges =  Clazz.newCharArray(-1, ['z', 'y', 'x', '\0', '\0', '\0', '\0', '\0', '\0', '\0', '\0', '\0']);
c$.edges =  Clazz.newByteArray(-1, [0, 1, 0, 2, 0, 4, 1, 3, 1, 5, 2, 3, 2, 6, 3, 7, 4, 5, 4, 6, 5, 7, 6, 7]);
c$.faceOrder =  Clazz.newIntArray(-1, [0, 3, 5, 2, 1, 4]);
c$.facePoints =  Clazz.newArray(-1, [ Clazz.newIntArray(-1, [4, 0, 6]),  Clazz.newIntArray(-1, [4, 6, 5]),  Clazz.newIntArray(-1, [5, 7, 1]),  Clazz.newIntArray(-1, [1, 3, 0]),  Clazz.newIntArray(-1, [6, 2, 7]),  Clazz.newIntArray(-1, [1, 0, 5]),  Clazz.newIntArray(-1, [0, 2, 6]),  Clazz.newIntArray(-1, [6, 7, 5]),  Clazz.newIntArray(-1, [7, 3, 1]),  Clazz.newIntArray(-1, [3, 2, 0]),  Clazz.newIntArray(-1, [2, 3, 7]),  Clazz.newIntArray(-1, [0, 4, 5])]);
c$.unitCubePoints =  Clazz.newArray(-1, [JU.P3.new3(0, 0, 0), JU.P3.new3(0, 0, 1), JU.P3.new3(0, 1, 0), JU.P3.new3(0, 1, 1), JU.P3.new3(1, 0, 0), JU.P3.new3(1, 0, 1), JU.P3.new3(1, 1, 0), JU.P3.new3(1, 1, 1)]);
