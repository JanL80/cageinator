...
/*LV!1824 unnec constructor*/c$.bytesToFloat = Clazz_defineMethod(c$, "bytesToFloat", 
...
this.out = null;
this.t8 = null;
Clazz_instantialize(this, arguments);}, JU, "BinaryDocument", JU.BC, javajs.api.GenericBinaryDocument);
Clazz_prepareFields (c$, function(){
...
Clazz_overrideMethod(c$, "setBigEndian", 
function(b){
this.isBigEndian = b;
}, "~B");
});
