...
(function(a){function h(a){try{return a?new window.ActiveXObject("Microsoft.XMLHTTP"):new window.XMLHttpRequest}catch(d){}}a.ajaxSettings.xhr=void 0===window.ActiveXObject?h:function(){return(this.url==document.location||0==this.url.indexOf("http")||!this.isLocal)&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&h()||h(1)};a.ajaxTransport("+script",function(a){var d,b=document.head||jQuery("head")[0]||document.documentElement;return{send:function(f,k){d=document.createElement("script");a.scriptCharset&&
...
var h=!1;try{k.hasOwnProperty("responseType")&&(k.responseType="arraybuffer",h=!0)}catch(m){}try{!h&&k.overrideMimeType&&k.overrideMimeType("text/plain; charset=x-user-defined")}catch(c){}!a.crossDomain&&!b["X-Requested-With"]&&(b["X-Requested-With"]="XMLHttpRequest");try{for(var e in b)k.setRequestHeader(e,b[e])}catch(j){}k.send(a.hasContent&&a.data||null);d=function(){var c=k.status,e="",j=k.getAllResponseHeaders(),b={};try{if(d&&4===k.readyState){d=void 0;try{b.text="string"===typeof k.responseText?
k.responseText:null}catch(h){}try{b.binary=k.response}catch(l){}try{e=k.statusText}catch(m){e=""}!c&&a.isLocal&&!a.crossDomain?c=b.text?200:404:1223===c&&(c=204);f(c,e,b,j)}}catch(t){alert(t),f(-1,t)}};a.async?4===k.readyState?setTimeout(d):k.onreadystatechange=d:d()},abort:function(){}}}))})(jQuery);
(function(a,h,g,d){function b(b,g){function l(c){a(m).each(function(){self.Jmol&&(0<=g.indexOf("mouseup")||0<=g.indexOf("touchend"))&&Jmol._setMouseOwner(null);var j=a(this);this!==c.target&&!j.has(c.target).length&&j.triggerHandler(g,[c.target,c])})}g=g||b+d;var m=a(),c=b+"."+g+"-special-event";a.event.special[g]={setup:function(){m=m.add(this);1===m.length&&a(h).bind(c,l)},teardown:function(){self.Jmol&&Jmol._setMouseOwner(null);m=m.not(this);0===m.length&&a(h).unbind(c)},add:function(a){var c=
...
Jmol._version||(Jmol=function(a){var h=function(a){return{rear:a++,header:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,consoleImage:a+91001,monitorZIndex:a+99999}},h={_version:"$Date: 2022-06-24 05:54:49 -0500 (Fri, 24 Jun 2022) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_allowKeyboardFocus:!0,_appletCssClass:"",_appletCssText:"",_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,
_ajaxQueue:[],_persistentMenu:!1,_getZOrders:h,_z:h(Jmol.z||9E3),_debugCode:!0,_debugCore:!1,db:{_databasePrefixes:"$=:",_fileLoadScript:";if (_loadScript = '' && defaultLoadScript == '' && _filetype == 'Pdb') { select protein or nucleic;cartoons Only;color structure; select * };",_nciLoadScript:";n = ({molecule=1}.length < {molecule=2}.length ? 2 : 1); select molecule=n;display selected;center selected;",_pubChemLoadScript:"",_DirectDatabaseCalls:{"cactus.nci.nih.gov":null,".x3dna.org":null,"rruff.geo.arizona.edu":null,
...
_isXHTML:!1,_lastAppletID:null,_mousePageX:null,_mouseOwner:null,_serverUrl:"https://your.server.here/jsmol.php",_syncId:(""+Math.random()).substring(3),_touching:!1,_XhtmlElement:null,_XhtmlAppendChild:!1};a=a.location.href.toLowerCase();h._debugCore=0<=a.indexOf("j2sdebugcore");h._httpProto=0==a.indexOf("https")?"https://":"http://";h._isFile=0==a.indexOf("file:");h._isFile&&$.ajaxSetup({mimeType:"text/plain"});h._ajaxTestSite=h._httpProto+"google.com";a=h._isFile||0==a.indexOf("http://localhost")||
0==a.indexOf("http://127.");h._tracker=!a&&"https://chemapps.stolaf.edu/jmol/JmolTracker.php?id=UA-45940799-1";h._isChrome=0<=navigator.userAgent.toLowerCase().indexOf("chrome");h._isSafari=!h._isChrome&&0<=navigator.userAgent.toLowerCase().indexOf("safari");h._isMsie=void 0!==window.ActiveXObject;h._isEdge=0<=navigator.userAgent.indexOf("Edge/");h._useDataURI=!h._isMsie&&!h._isEdge;window.requestAnimationFrame||(window.requestAnimationFrame=window.setTimeout);for(var g in Jmol)h[g]=Jmol[g];return h}(document,
Jmol));
(function(a,h){a.clazzAlert=function(){};a.__$=h;h(document).ready(function(){a._document=null});a.$=function(a,e){null==a&&alert(e+arguments.callee.caller.toString());return h(e?"#"+a._id+"_"+e:a)};a._$=function(a){return"string"==typeof a?h("#"+a):a};a.$ajax=function(c){a._ajaxCall=c.url;c.cache="NO"!=c.cache;c.url=a._fixProtocol(c.url);return h.ajax(c)};a._fixProtocol=function(c){0<=c.indexOf("get3d=True")&&(c=c.replace(/get3d\=True/,"get3d=true"));return 0==c.indexOf("http://www.rcsb.org/pdb/files/")&&0>
c.indexOf("/ligand/")?"http://files.rcsb.org/view/"+c.substring(30).replace(/\.gz/,""):0==c.indexOf("http://")&&("https://"==a._httpProto||0<c.indexOf(".gov/")||0==c.indexOf("http://www.materialsproject"))?"https"+c.substring(4):c};a._getNCIInfo=function(c,e){return a._getFileData("https://cactus.nci.nih.gov/chemical/structure/"+c+"/"+("name"==e?"names":e))};a.$appEvent=function(c,e,j,b){c=a.$(c,e);c.off(j)&&b&&c.on(j,b)};a.$resize=function(a){return h(window).resize(a)};a.$after=function(a,e){return h(a).after(e)};
a.$append=function(a,e){return h(a).append(e)};a.$bind=function(a,e,j){return j?h(a).bind(e,j):h(a).unbind(e)};a.$closest=function(a,e){return h(a).closest(e)};a.$get=function(a,e){return h(a).get(e)};a.$documentOff=function(a,e){return h(document).off(a,"#"+e)};a.$documentOn=function(a,e,j){return h(document).on(a,"#"+e,j)};a.$getAncestorDiv=function(a,e){return h("div."+e+":has(#"+a+")")[0]};a.$supportsIECrossDomainScripting=function(){return h.support.iecors};a.$attr=function(c,e,j){return a._$(c).attr(e,
j)};a.$css=function(c,e){return a._$(c).css(e)};a.$find=function(c,e){return a._$(c).find(e)};a.$focus=function(c){return a._$(c).focus()};a.$html=function(c,e){return a._$(c).html(e)};a.$offset=function(c){return a._$(c).offset()};a.$windowOn=function(a,e){return h(window).on(a,e)};a.$prop=function(c,e,j){var b=a._$(c);return 3==arguments.length?b.prop(e,j):b.prop(e)};a.$remove=function(c){return a._$(c).remove()};a.$scrollTo=function(c,e){var j=a._$(c);return j.scrollTop(0>e?j[0].scrollHeight:e)};
a.$setEnabled=function(c,e){return a._$(c).attr("disabled",e?null:"disabled")};a.$getSize=function(c){c=a._$(c);return[c.width(),c.height()]};a.$setSize=function(c,e,j){return a._$(c).width(e).height(j)};a.$is=function(c,e){return a._$(c).is(e)};a.$setVisible=function(c,e){var j=a._$(c);return e?j.show():j.hide()};a.$submit=function(c){return a._$(c).submit()};a.$val=function(c,e){var j=a._$(c);return 1==arguments.length?j.val():j.val(e)};a._clearVars=function(){delete jQuery;delete h;delete a;delete SwingController;
delete J;delete JM;delete JS;delete JSV;delete JU;delete JV;delete java;delete javajs;delete Clazz;delete c$};var g=document,d=window,b={};b.ua=navigator.userAgent.toLowerCase();var f;a:{f=["linux","unix","mac","win"];for(var k=f.length;k--;)if(-1!=b.ua.indexOf(f[k])){f=f[k];break a}f="unknown"}b.os=f;b.browser=function(){for(var a=b.ua,e="konqueror webkit omniweb opera webtv icab msie mozilla".split(" "),j=0;j<e.length;j++)if(0<=a.indexOf(e[j]))return e[j];return"unknown"};b.browserName=b.browser();
b.browserVersion=parseFloat(b.ua.substring(b.ua.indexOf(b.browserName)+b.browserName.length+1));b.supportsXhr2=function(){return h.support.cors||h.support.iecors};b.allowDestroy="msie"!=b.browserName;b.allowHTML5="msie"!=b.browserName||0>navigator.appVersion.indexOf("MSIE 8");b.getDefaultLanguage=function(){return navigator.language||navigator.userLanguage||"en-US"};b._webGLtest=0;b.supportsWebGL=function(){if(!a.featureDetection._webGLtest){var c;a.featureDetection._webGLtest=d.WebGLRenderingContext&&
...
a._grabberOptions.length)return"";var e='<input type="text" id="ID_query" onfocus="jQuery(this).select()" onkeypress="if(13==event.which){Jmol._applets[\'ID\']._search();return false}" size="32" value="" />',j='<button id="ID_submit" onclick="Jmol._applets[\'ID\']._search()">Search</button></nobr>';1==a._grabberOptions.length?(e="<nobr>"+e+'<span style="display:none">',j="</span>"+j):e+="<br /><nobr>";for(var e=e+'<select id="ID_select">',b=0;b<a._grabberOptions.length;b++)var d=a._grabberOptions[b],
e=e+('<option value="'+d[0]+'" '+(0==b?"selected":"")+">"+d[1]+"</option>");e=(e+"</select>"+j).replace(/ID/g,c._id);return"<br />"+e};a._getScriptForDatabase=function(c){return"$"==c?a.db._nciLoadScript:":"==c?a.db._pubChemLoadScript:a.db._fileLoadScript};a._setInfo=function(a,e,j){var b=[],d="";if(0==j.indexOf("ERROR"))d=j;else switch(e){case "=":e=j.split("<dimStructure.structureId>");b=["<table>"];for(j=1;j<e.length;j++)b.push('<tr><td valign=top><a href="javascript:Jmol.search('+a._id+",'="+
e[j].substring(0,4)+"')\">"+e[j].substring(0,4)+"</a></td>"),b.push("<td>"+e[j].split("Title>")[1].split("</")[0]+"</td></tr>");b.push("</table>");d=e.length-1+" matches";break;case "$":case ":":break;default:return}a._infoHeader=d;a._info=b.join("");a._showInfo(!0)};a._loadSuccess=function(c,e){e&&(a._ajaxDone(),e(c))};a._loadError=function(c){a._ajaxDone();a.say("Error connecting to server: "+a._ajaxCall);null!=c&&c()};a._isDatabaseCall=function(c){return 0<=a.db._databasePrefixes.indexOf(c.substring(0,
1))};a._getDirectDatabaseCall=function(c,e){if(e&&!a.featureDetection.supportsXhr2())return c;var j=2,b=c.substring(0,j),d=a.db._DirectDatabaseCalls[b]||a.db._DirectDatabaseCalls[b=c.substring(0,--j)];d&&(":"==b?(b=c.toLowerCase(),isNaN(parseInt(c.substring(1)))?0==b.indexOf(":smiles:")?(d+="?POST?smiles="+c.substring(8),c="smiles"):0==b.indexOf(":cid:")?c="cid/"+c.substring(5):(0==b.indexOf(":name:")?c=c.substring(5):0==b.indexOf(":cas:")&&(c=c.substring(4)),c="name/"+encodeURIComponent(c.substring(j))):
c="cid/"+c.substring(1)):c=encodeURIComponent(c.substring(j)),0<=c.indexOf(".mmtf")?c="https://mmtf.rcsb.org/v1.0/full/"+c.replace(/\.mmtf/,""):0<=d.indexOf("FILENCI")?(c=c.replace(/\%2F/g,"/"),c=d.replace(/\%FILENCI/,c)):c=d.replace(/\%FILE/,c));return c};a._getRawDataFromServer=function(c,e,j,b,d,f){c="?call=getRawDataFromDatabase&database="+c+(0<=e.indexOf("?POST?")?"?POST?":"")+"&query="+encodeURIComponent(e)+(d?"&encoding=base64":"")+(f?"":"&script="+encodeURIComponent(a._getScriptForDatabase(c)));
return a._contactServer(c,j,b)};a._checkFileName=function(c,e,j){a._isDatabaseCall(e)&&(j&&a._setQueryTerm(c,e),e=a._getDirectDatabaseCall(e,!0),a._isDatabaseCall(e)&&(e=a._getDirectDatabaseCall(e,!1),j&&(j[0]=!0)));return e};a._checkCache=function(c,e,j){if(c._cacheFiles&&a._fileCache&&!e.endsWith(".js")){if(c=a._fileCache[e])return System.out.println("using "+c.length+" bytes of cached data for "+e),j(c),null;j=function(c,e){j(a._fileCache[c]=e)}}return j};a.playAudio=function(c){a.playAudio(null,
c)};a.playAudio=function(a,e){var j=e.get?function(a){return e.get(a)}:null,b=e.put?function(a,c){return e.put(a,c)}:null,d=j?j("audioFile"):e,f=j&&j("audioPlayer"),g=document.createElement("audio");b&&b("audioElement",g);var k=null;f&&(k=function(a){f.processUpdate(a)},f.myClip={open:function(){k("open")},start:function(){g.play();k("start")},loop:function(a){g.loop=0!=a},stop:function(){g.pause()},close:function(){k("close")},setMicrosecondPosition:function(a){g.currentTime=a/1E6}});g.controls=
"true";g.src=d;j&&j("loop")&&(g.loop="true");k&&(g.addEventListener("pause",function(){k("pause")}),g.addEventListener("play",function(){k("play")}),g.addEventListener("playing",function(){k("playing")}),g.addEventListener("ended",function(){k("ended")}),k("open"))};a._loadFileData=function(c,e,j,b){var d=[];e=a._checkFileName(c,e,d);j=a._checkCache(c,e,j);d[0]?a._getRawDataFromServer("_",e,j,b):(c={type:"GET",dataType:"text",url:e,async:a._asynchronous,success:function(c){a._loadSuccess(c,j)},error:function(){a._loadError(b)}},
a._checkAjaxPost(c),a._ajax(c))};a._getInfoFromDatabase=function(c,e,j){if("===="==e){var b=a.db._restQueryXml.replace(/QUERY/,j),b={dataType:"text",type:"POST",contentType:"application/x-www-form-urlencoded",url:a.db._restQueryUrl,data:encodeURIComponent(b)+"&req=browser",success:function(b){a._ajaxDone();a._extractInfoFromRCSB(c,e,j,b)},error:function(){a._loadError(null)},async:a._asynchronous};return a._ajax(b)}j="?call=getInfoFromDatabase&database="+e+"&query="+encodeURIComponent(j);return a._contactServer(j,
function(j){a._setInfo(c,e,j)})};a._extractInfoFromRCSB=function(c,e,j,b){var d=b.length/5;if(0!=d&&4==j.length&&1!=d){j=j.toUpperCase();var f=b.indexOf(j);0<f&&0<="123456789".indexOf(j.substring(0,1))&&(b=j+","+b.substring(0,f)+b.substring(f+5));50<d&&(b=b.substring(0,250));b=b.replace(/\n/g,",");b=a._restReportUrl.replace(/IDLIST/,b);a._loadFileData(c,b,function(j){a._setInfo(c,e,j)})}};a._checkAjaxPost=function(a){var e=a.url.indexOf("?POST?");0<e&&(a.data=a.url.substring(e+6),a.url=a.url.substring(0,
e),a.type="POST",a.contentType="application/x-www-form-urlencoded")};a._contactServer=function(c,e,j){c={dataType:"text",type:"GET",url:a._serverUrl+c,success:function(c){a._loadSuccess(c,e)},error:function(){a._loadError(j)},async:e?a._asynchronous:!1};a._checkAjaxPost(c);return a._ajax(c)};a._setQueryTerm=function(c,e){if(e&&c._hasOptions&&"http://"!=e.substring(0,7)){if(a._isDatabaseCall(e)){var j=e.substring(0,1);e=e.substring(1);e.substring(0,1)==j&&0<="=$".indexOf(j)&&(e=e.substring(1));var b=
a._getElement(c,"select");if(b&&b.options)for(var d=0;d<b.options.length;d++)b[d].value==j&&(b[d].selected=!0)}a.$val(a.$(c,"query"),e)}};a._search=function(c,e,j){1<arguments.length||(e=null);a._setQueryTerm(c,e);e||(e=a.$val(a.$(c,"query")));0==e.indexOf("!")?c._script(e.substring(1)):(e&&(e=e.replace(/\"/g,"")),c._showInfo(!1),a._searchMol(c,e,j,!0))};a._searchMol=function(c,e,j,b){var d;a._isDatabaseCall(e)?(d=e.substring(0,1),e=e.substring(1)):d=c._hasOptions?a.$val(a.$(c,"select")):"$";"="==
d&&3==e.length&&(e="="+e);var f=d+e;if(e&&!(0>f.indexOf("?")&&f==c._thisJmolModel)){c._thisJmolModel=f;var g;b&&null!=c._viewSet&&null!=(g=a.View.__findView(c._viewSet,{chemID:f}))?a.View.__setView(g,c,!1):("$"==d||":"==d?c._jmolFileType="MOL":"="==d&&(c._jmolFileType="PDB"),c._searchDatabase(e,d,j))}};a._searchDatabase=function(c,e,j,b){c._showInfo(!1);return 0<=e.indexOf("?")?(a._getInfoFromDatabase(c,j,e.split("?")[0]),!0):a.db._DirectDatabaseCalls[j]?(c._loadFile(j+e,b),!0):!1};a._syncBinaryOK=
"?";a._canSyncBinary=function(c){if(a._isAsync)return!0;if(self.VBArray)return a._syncBinaryOK=!1;if("?"!=a._syncBinaryOK)return a._syncBinaryOK;a._syncBinaryOK=!0;try{var e=new window.XMLHttpRequest;e.open("text",a._ajaxTestSite,!1);e.hasOwnProperty("responseType")?e.responseType="arraybuffer":e.overrideMimeType&&e.overrideMimeType("text/plain; charset=x-user-defined")}catch(j){return System.out.println("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._alertNoBinary&&
!c&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=!1}return!0};a._binaryTypes=".cdx mmtf .bcif .gz .bz2 .jpg .gif .png .zip .jmol .bin .smol .spartan .pmb .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd .lut .uk/pdbe/densities/ .uk/pdbe/volume-server/".split(" ");a.isBinaryUrl=function(c){for(var e=a._binaryTypes.length;0<=--e;)if(0<=c.indexOf(a._binaryTypes[e]))return!0;return!1};a._getFileData=function(c,e,j){var b=a.isBinaryUrl(c),d=0<=c.indexOf(".gz")&&
0<=c.indexOf("rcsb.org");d&&(c=c.replace(/\.gz/,""),b=!1);var d=b&&!e&&!a._canSyncBinary(d),f=0<=c.indexOf("?POST?");0==c.indexOf("file:/")&&0!=c.indexOf("file:///")&&(c="file://"+c.substring(5));var g=0>c.indexOf("://")||0==c.indexOf(document.location.protocol)&&0<=c.indexOf(document.location.host),k="https://"==a._httpProto&&0==c.indexOf("http://"),h=a._isDirectCall(c);0<=c.indexOf("?ALLOWSORIGIN?")&&(c=c.replace(/\?ALLOWSORIGIN\?/,""));var l=!g&&a.$supportsIECrossDomainScripting(),m=null;if(k||
d||!g&&!h||!e&&l)m=a._getRawDataFromServer("_",c,e,e,d,!0);else{c=c.replace(/file:\/\/\/\//,"file://");var r={dataType:b?"binary":"text",async:!!e};f?(r.type="POST",r.url=c.split("?POST?")[0],r.data=c.split("?POST?")[1],r.data.startsWith('{"')&&(r.contentType="application/json",r.data=r.data.replaceAll("\n","\\\\n"))):(r.type="GET",r.url=c);e&&(r.success=function(){e(a._xhrReturn(r.xhr))},r.error=function(){e(r.xhr.statusText)});r.xhr=a.$ajax(r);e||(m=a._xhrReturn(r.xhr))}if(!j)return m;null==m&&
...
function(){var c=prompt("Enter a URL");c&&(a._hideLocalFileReader(e,0),a._setData(null,c,c,null,b,e))});a.$appEvent(e,"localReader_loadfile","click");a.$appEvent(e,"localReader_loadfile","click",function(){var j=a.$(e,"localReader_files")[0].files[0],d=new FileReader;d.onloadend=function(d){d.target.readyState==FileReader.DONE&&(a._hideLocalFileReader(e,0),a._setData(c,j.name,j.name,d.target.result,b,e))};try{d.readAsArrayBuffer(j)}catch(f){alert("You must select a file first.")}});a.$appEvent(e,
"localReader_cancel","click");a.$appEvent(e,"localReader_cancel","click",function(){a._hideLocalFileReader(e);c&&c.setData("#CANCELED#",null,null,b,e)});a.$setVisible(e._localReader,!0);e._readingLocal=!0};a._setData=function(c,e,j,b,d,f){b&&(b=a._strToBytes(b));null!=b&&(null==c||0<=e.indexOf(".jdx"))&&a.Cache.put("cache://"+e,b);null==c?f._applet.openFileAsyncSpecial(null==b?e:"cache://"+e,1):c.setData(e,j,b,d)};a.doAjax=function(c,e,j){c=c.toString();if(j){if(0!=c.indexOf("http://")&&0!=c.indexOf("https://"))return a._saveFile(c,
j);c={async:!1,url:c,type:"POST",data:"string"==typeof data?j:";base64,"+(JU||J.util).Base64.getBase64(j).toString(),processData:!1};return a.$ajax(c).responseText}e&&(c+="?POST?"+e);return a._getFileData(c,null,!0)};a._saveFile=function(c,e,j,b){if(a._localFileSaveFunction&&a._localFileSaveFunction(c,e))return"OK";c=c.substring(c.lastIndexOf("/")+1);j||(j=0<=c.indexOf(".pdf")?"application/pdf":0<=c.indexOf(".png")?"image/png":0<=c.indexOf(".gif")?"image/gif":0<=c.indexOf(".jpg")?"image/jpg":"");
var d="string"==typeof e;e=d&&0<=e.indexOf(";base64,")?e.split(";base64,")[1]:(JU||J.util).Base64.getBase64(d?e.getBytes("UTF-8"):e).toString();b||(b="base64");(d=a._serverUrl)&&0<=d.indexOf("your.server")&&(d="");a._useDataURI||!d?(b=document.createElement("a"),b.href="data:"+j+";base64,"+e,b.type=j||"text/plain;charset=utf-8",b.download=c,b.target="_blank",h("body").append(b),b.click(),b.remove()):(a._formdiv||(a.$after("body",'<div id="__jsmolformdiv__" style="display:none">\t\t\t\t\t\t<form id="__jsmolform__" method="post" target="_blank" action="">\t\t\t\t\t\t<input name="call" value="saveFile"/>\t\t\t\t\t\t<input id="__jsmolmimetype__" name="mimetype" value=""/>\t\t\t\t\t\t<input id="__jsmolencoding__" name="encoding" value=""/>\t\t\t\t\t\t<input id="__jsmolfilename__" name="filename" value=""/>\t\t\t\t\t\t<textarea id="__jsmoldata__" name="data"></textarea>\t\t\t\t\t\t</form>\t\t\t\t\t\t</div>'),
a._formdiv="__jsmolform__"),a.$attr(a._formdiv,"action",d+"?"+(new Date).getMilliseconds()),a.$val("__jsmoldata__",e),a.$val("__jsmolfilename__",c),a.$val("__jsmolmimetype__",j),a.$val("__jsmolencoding__",b),a.$submit("__jsmolform__"),a.$val("__jsmoldata__",""),a.$val("__jsmolfilename__",""));return"OK"};a._strToBytes=function(a){if(Clazz.instanceOf(a,self.ArrayBuffer))return Clazz.newByteArray(-1,a);for(var e=Clazz.newByteArray(a.length,0),j=a.length;0<=--j;)e[j]=a.charCodeAt(j)&255;return e};a._setConsoleDiv=
function(a){self.Clazz&&Clazz.setConsoleDiv(a)};a._registerApplet=function(c,e){return window[c]=a._applets[c]=a._applets.master=a._applets[c+"__"+a._syncId+"__"]=e};a._readyCallback=function(c,e,j,b,d){c=c.split("_object")[0];var f=a._applets[c];if(j=j.booleanValue?j.booleanValue():j)f._appletPanel=d||b,f._applet=b;a._track(f)._readyCallback(c,e,j)};a._getWrapper=function(c,e){var j;if(e){var b="";if(c._coverImage)var b=' onclick="Jmol.coverApplet(ID, false)" title="'+c._coverTitle+'"',d='<image id="ID_coverclickgo" src="'+
...
a._getZ(c,"coverImage")+';" />';j=a._appletCssText.replace(/\'/g,'"');var f=c._getSpinner&&c._getSpinner();c._spinner=f=!f||"none"==f?"":"background-image:url("+f+"); background-repeat:no-repeat; background-position:center;";j=f+(0<=j.indexOf('style="')?j.split('style="')[1]:'" '+j);j='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG WAIT......<div id="ID_appletdiv" style="z-index:'+a._getZ(c,"header")+";width:100%;height:100%;position:absolute;top:0px;left:0px;"+
j+">";var f=c._height,g=c._width;if("string"!==typeof f||0>f.indexOf("%"))f+="px";if("string"!==typeof g||0>g.indexOf("%"))g+="px";j=j.replace(/IMG/,b).replace(/WAIT/,d).replace(/Hpx/g,f).replace(/Wpx/g,g)}else j='......</div>......<div id="ID_2dappletdiv" style="position:absolute;width:100%;height:100%;overflow:hidden;display:none"></div>......<div id="ID_infotablediv" style="width:100%;height:100%;position:absolute;top:0px;left:0px">.........<div id="ID_infoheaderdiv" style="height:20px;width:100%;background:yellow;display:none"><span id="ID_infoheaderspan"></span><span id="ID_infocheckboxspan" style="position:absolute;text-align:right;right:1px;"><a href="javascript:Jmol.showInfo(ID,false)">[x]</a></span></div>.........<div id="ID_infodiv" style="position:absolute;top:20px;bottom:0px;width:100%;height:100%;overflow:auto"></div>......</div>...</div>';
return j.replace(/\.\.\./g,"").replace(/[\n\r]/g,"").replace(/ID/g,c._id)};a._hideLoadingSpinner=function(c){c._spinner&&a.$css(a.$(c,"appletdiv"),{"background-image":""})};a._documentWrite=function(c){if(a._document){if(a._isXHTML&&!a._XhtmlElement){var e=document.getElementsByTagName("script");a._XhtmlElement=e.item(e.length-1);a._XhtmlAppendChild=!1}a._XhtmlElement?a._domWrite(c):a._document.write(c)}return c};a._domWrite=function(c){for(var e=[0];e[0]<c.length;){var j=a._getDomElement(c,e);if(!j)break;
a._XhtmlAppendChild?a._XhtmlElement.appendChild(j):a._XhtmlElement.parentNode.insertBefore(j,_jmol.XhtmlElement)}};a._getDomElement=function(a,e){var j=document.createElement("span");j.innerHTML=a;e[0]=a.length;return j};a._setObject=function(c,e,j){c._id=e;c.__Info={};j.z&&j.zIndexBase&&(a._z=a._getZOrders(j.zIndexBase));for(var b in j)c.__Info[b]=j[b];(c._z=j.z)||j.zIndexBase&&(c._z=c.__Info.z=a._getZOrders(j.zIndexBase));c._width=j.width;c._height=j.height;c._noscript=!c._isJava&&j.noscript;c._console=
j.console;c._cacheFiles=!!j.cacheFiles;c._viewSet=null==j.viewSet||c._isJava?null:"Set"+j.viewSet;null!=c._viewSet&&(a.View.__init(c),c._currentView=null);!a._fileCache&&c._cacheFiles&&(a._fileCache={});c._console||(c._console=c._id+"_infodiv");"none"==c._console&&(c._console=null);c._color=j.color?j.color.replace(/0x/,"#"):"#FFFFFF";c._disableInitialConsole=j.disableInitialConsole;c._noMonitor=j.disableJ2SLoadMonitor;a._j2sPath&&(j.j2sPath=a._j2sPath);c._j2sPath=j.j2sPath;c._coverImage=j.coverImage;
c._makeLiveImage=j.makeLiveImage||j.j2sPath+"/img/play_make_live.jpg";c._isCovered=!!c._coverImage;c._deferApplet=j.deferApplet||c._isCovered&&c._isJava;c._deferUncover=j.deferUncover&&!c._isJava;c._coverScript=j.coverScript;c._coverTitle=j.coverTitle;c._coverTitle||(c._coverTitle=c._deferApplet?"activate 3D model":"3D model is loading...");c._containerWidth=c._width+(c._width==parseFloat(c._width)?"px":"");c._containerHeight=c._height+(c._height==parseFloat(c._height)?"px":"");c._info="";c._infoHeader=
c._jmolType+' "'+c._id+'"';c._hasOptions=j.addSelectionOptions;c._defaultModel=j.defaultModel;c._readyScript=j.script?j.script:"";c._readyFunction=j.readyFunction;c._coverImage&&!c._deferApplet&&(c._readyScript+=";javascript "+e+"._displayCoverImage(false)");c._src=j.src};a._addDefaultInfo=function(c,e){for(var b in e)"undefined"==typeof c[b]&&(c[b]=e[b]);a._use&&(c.use=a._use);0<=c.use.indexOf("SIGNED")&&(0>c.jarFile.indexOf("Signed")&&(c.jarFile=c.jarFile.replace(/Applet/,"AppletSigned")),c.use=
c.use.replace(/SIGNED/,"JAVA"),c.isSigned=!0)};a._syncedApplets=[];a._syncedCommands=[];a._syncedReady=[];a._syncReady=!1;a._isJmolJSVSync=!1;a._setReady=function(c){a._syncedReady[c]=1;for(var e=0,b=0;b<a._syncedApplets.length;b++){if(a._syncedApplets[b]==c._id)a._syncedApplets[b]=c,a._syncedReady[b]=1;else if(!a._syncedReady[b])continue;e++}e==a._syncedApplets.length&&a._setSyncReady()};a._setDestroy=function(c){a.featureDetection.allowDestroy&&a.$windowOn("beforeunload",function(){a._destroy(c)})};
a._destroy=function(c){try{c._appletPanel&&c._appletPanel.destroy();c._applet=null;a._unsetMouse(c._canvas);c._canvas=null;for(var e=0,b=0;b<a._syncedApplets.length;b++)a._syncedApplets[b]==c&&(a._syncedApplets[b]=null),a._syncedApplets[b]&&e++;0<e||a._clearVars()}catch(d){}};a._setSyncReady=function(){a._syncReady=!0;if(a._isJmolJSVSync)for(var c=a._syncedApplets,e=0;e<c.length-1;e+=2)c[e]._linkedApplet=c[e+1],c[e+1]._linkedApplet=c[e];c="";for(e=0;e<a._syncedApplets.length;e++)a._syncedCommands[e]&&
(c+="Jmol.script(Jmol._syncedApplets["+e+"], Jmol._syncedCommands["+e+"]);");setTimeout(c,50)};a._mySyncCallback=function(c,e){app=a._applets[c];if(app._viewSet)a.View.updateFromSync(app,e);else{if(!a._syncReady||!a._isJmolJSVSync)return 1;app._linkedApplet&&0<=e.indexOf(app._linkedApplet._syncKeyword)&&app._linkedApplet._syncScript(e);return 0}};a._getElement=function(a,e){return document.getElementById(a._id+"_"+e)||{}};a._evalJSON=function(a,e){a+="";if(!a)return[];if("{"!=a.charAt(0))return 0<=
a.indexOf(" | ")&&(a=a.replace(/\ \|\ /g,"\n")),a;var b=(new Function("return "+a))();return!b?null:e&&void 0!=b[e]?b[e]:b};a._sortMessages=function(a){function e(a,c){return a[0]<c[0]?1:a[0]>c[0]?-1:0}if(!a||"object"!=typeof a)return[];for(var b=[],d=a.length-1;0<=d;d--)for(var f=0,g=a[d].length;f<g;f++)b[b.length]=a[d][f];if(0!=b.length)return b=b.sort(e)};a._setMouseOwner=function(c,e){null==c||e?(a._mouseOwner=c)&&c._applet&&(a._lastAppletID=c._applet._id):a._mouseOwner==c&&(a._mouseOwner=null)};
a._jsGetMouseModifiers=function(a){var e=0;switch(a.button){case 0:e=16;break;case 1:e=8;break;case 2:e=4}a.shiftKey&&(e+=1);a.altKey&&(e+=8);a.ctrlKey&&(e+=2);return e};a._jsGetXY=function(c,e){if(!c.applet._ready||a._touching&&0>e.type.indexOf("touch"))return!1;var b=a.$offset(c.id),d,f=e.originalEvent;e.pageX||(e.pageX=f.pageX);e.pageY||(e.pageY=f.pageY);a._mousePageX=e.pageX;a._mousePageY=e.pageY;f.targetTouches&&f.targetTouches[0]?(d=f.targetTouches[0].pageX-b.left,b=f.targetTouches[0].pageY-
b.top):f.changedTouches?(d=f.changedTouches[0].pageX-b.left,b=f.changedTouches[0].pageY-b.top):(d=e.pageX-b.left,b=e.pageY-b.top);return void 0==d?null:[Math.round(d),Math.round(b),a._jsGetMouseModifiers(e)]};a.setCursor=function(c,e){if(!c._isJava&&!c._readingLocal){var b;switch(e){case 1:b="crosshair";break;case 3:b="wait";a.$setVisible(a.$(c,"waitimage"),!0);break;case 8:b="ns-resize";break;case 12:b="grab";break;case 13:b="move";break;default:a.$setVisible(a.$(c,"waitimage"),!1),b="default"}c._canvas.style.cursor=
b}};a._gestureUpdate=function(c,e){e.stopPropagation();e.preventDefault();var b=e.originalEvent;switch(e.type){case "touchstart":a._touching=!0;break;case "touchend":a._touching=!1}if(!b.touches||2!=b.touches.length)return!1;switch(e.type){case "touchstart":c._touches=[[],[]];break;case "touchmove":var d=a.$offset(c.id),f=c._touches[0],g=c._touches[1];f.push([b.touches[0].pageX-d.left,b.touches[0].pageY-d.top]);g.push([b.touches[1].pageX-d.left,b.touches[1].pageY-d.top]);b=f.length;3<b&&(f.shift(),
g.shift());2<=b&&c.applet._processGesture(c._touches)}return!0};a._jsSetMouse=function(c){var e=function(a){return!a.target||0<=(""+a.target.className).indexOf("swingjs-ui")};a.$bind(c,"mousedown touchstart",function(b){if(e(b))return!0;a._allowKeyboardFocus&&c.focus();a._setMouseOwner(c,!0);b.stopPropagation();var d=b.target["data-UI"];(!d||!d.handleJSEvent(c,501,b))&&b.preventDefault();c.isDragging=!0;if("touchstart"==b.type&&a._gestureUpdate(c,b))return!!d;a._setConsoleDiv(c.applet._console);var f=
a._jsGetXY(c,b);f&&(2!=b.button&&a.Swing.hideMenus(c.applet),c.applet._processEvent(501,f));return!!d});a.$bind(c,"mouseup touchend",function(b){if(e(b))return!0;a._setMouseOwner(null);b.stopPropagation();var d=b.target["data-UI"];(!d||!d.handleJSEvent(c,502,b))&&b.preventDefault();c.isDragging=!1;if("touchend"==b.type&&a._gestureUpdate(c,b))return!!d;(b=a._jsGetXY(c,b))&&c.applet._processEvent(502,b);return!!d});a.$bind(c,"mousemove touchmove",function(b){if(e(b))return!0;a._allowKeyboardFocus&&
c.focus();if(a._mouseOwner&&a._mouseOwner!=c&&a._mouseOwner.isDragging){if(!a._mouseOwner.mouseMove)return!0;a._mouseOwner.mouseMove(b);return!1}return a._drag(c,b)});a.$bind(c,"keydown keyup",function(b){if(e(b))return!0;b.stopPropagation();b.preventDefault();var d=a._jsGetXY(c,b),f="keydown"==b.type?401:402;c.applet._processKeyEvent&&c.applet._processKeyEvent(f,d,b);return!0});a._drag=function(c,b){b.stopPropagation();b.preventDefault();if("touchmove"==b.type&&a._gestureUpdate(c,b))return!1;var e=
a._jsGetXY(c,b);if(!e)return!1;c.isDragging||(e[2]=0);var d=b.target["data-UI"];c.isdragging&&(!d||d.handleJSEvent(c,506,b));c.applet._processEvent(c.isDragging?506:503,e);return!!d};a.$bind(c,"DOMMouseScroll mousewheel",function(b){if(e(b))return!0;b.stopPropagation();b.preventDefault();c.isDragging=!1;var d=b.originalEvent,d=d.detail?d.detail:("mac"==a.featureDetection.os?1:-1)*d.wheelDelta;b=a._jsGetMouseModifiers(b);c.applet._processEvent(507,[0>d?-1:1,0,b]);return!1});a.$bind(c,"contextmenu",
function(){return!1});a.$bind(c,"mouseout",function(b){if(e(b))return!0;a._mouseOwner&&(!a._mouseOwner.mouseMove&&!a._mouseOwner.isDragging)&&a._setMouseOwner(null);c.applet._appletPanel&&c.applet._appletPanel.startHoverWatcher(!1);a._jsGetXY(c,b);return!1});a.$bind(c,"mouseenter",function(b){if(e(b))return!0;c.applet._appletPanel&&c.applet._appletPanel.startHoverWatcher(!0);if(0===b.buttons||0===b.which){c.isDragging=!1;b=a._jsGetXY(c,b);if(!b)return!1;c.applet._processEvent(504,b);c.applet._processEvent(502,
b);return!1}});a.$bind(c,"mousemoveoutjsmol",function(b,d,f){if(e(f))return!0;if(c==a._mouseOwner&&c.isDragging)return a._drag(c,f)});c.applet._is2D&&a.$resize(function(){c.applet&&c.applet._resize()});a.$bind("body","mouseup touchend",function(b){if(e(b))return!0;c.applet&&(c.isDragging=!1);a._setMouseOwner(null)})};a._jsUnsetMouse=function(c){c.applet=null;a.$bind(c,"mousedown touchstart mousemove touchmove mouseup touchend DOMMouseScroll mousewheel contextmenu mouseout mouseenter",null);a._setMouseOwner(null)};
a.Swing={count:0,menuInitialized:0,menuCounter:0,htDialogs:{}};var l=a.Swing;SwingController=l;l.setDraggable=function(c){c=c.prototype;c.setContainer||(c.setContainer=function(c){this.container=c;c.obj=this;this.ignoreMouse=this.isDragging=!1;var b=this;c.bind("mousedown touchstart",function(c){if(b.ignoreMouse)return b.ignoreMouse=!1,!0;a._setMouseOwner(b,!0);b.isDragging=!0;b.pageX=c.pageX;b.pageY=c.pageY;return!1});c.bind("mousemove touchmove",function(c){if(b.isDragging&&a._mouseOwner==b)return b.mouseMove(c),
!1});c.bind("mouseup touchend",function(c){b.mouseUp(c);a._setMouseOwner(null)})},c.mouseUp=function(c){if(this.isDragging&&a._mouseOwner==this)return this.pageX0+=c.pageX-this.pageX,this.pageY0+=c.pageY-this.pageY,this.isDragging=!1;a._setMouseOwner(null)},c.setPosition=function(){if(null===a._mousePageX){var c=a.$offset(this.applet._id+"_"+(this.applet._is2D?"canvas2d":"canvas"));a._mousePageX=c.left;a._mousePageY=c.top}this.pageX0=a._mousePageX;this.pageY0=a._mousePageY;this.container.css({top:a._mousePageY+
"px",left:a._mousePageX+"px"})},c.mouseMove=function(c){if(this.isDragging&&a._mouseOwner==this){this.timestamp=System.currentTimeMillis();var b=this.pageX0+(c.pageX-this.pageX);c=this.pageY0+(c.pageY-this.pageY);a._mousePageX=b;a._mousePageY=c;this.container.css({top:c+"px",left:b+"px"})}},c.dragBind=function(c){this.applet._ignoreMouse=!c;this.container.unbind("mousemoveoutjsmol");this.container.unbind("touchmoveoutjsmol");this.container.unbind("mouseupoutjsmol");this.container.unbind("touchendoutjsmol");
a._setMouseOwner(null);if(c){var b=this;this.container.bind("mousemoveoutjsmol touchmoveoutjsmol",function(a,c,e){b.mouseMove(e)});this.container.bind("mouseupoutjsmol touchendoutjsmol",function(a,c,e){b.mouseUp(e)})}})};l.JSDialog=function(){};l.setDraggable(l.JSDialog);l.getScreenDimensions=function(a){a.width=h(window).width();a.height=h(window).height()};l.dispose=function(c){a.$remove(c.id+"_mover");delete l.htDialogs[c.id];c.container.obj.dragBind(!1)};l.register=function(a,b){a.id=b+ ++l.count;
l.htDialogs[a.id]=a};l.setDialog=function(c){a._setMouseOwner(null);a.$remove(c.id);var b=c.id+"_mover",d=a._$(b),f;d[0]?(d.html(c.html),f=d[0].jd):(a.$after("body","<div id='"+b+"' style='position:absolute;left:0px;top:0px;'>"+c.html+"</div>"),f=new l.JSDialog,d=a._$(b),c.container=d,f.applet=c.manager.vwr.html5Applet,f.setContainer(d),f.dialog=c,f.setPosition(),f.dragBind(!0),d[0].jd=f);a.$bind("#"+c.id+" .JButton","mousedown touchstart",function(){f.ignoreMouse=!0});a.$bind("#"+c.id+" .JComboBox",
"mousedown touchstart",function(){f.ignoreMouse=!0});a.$bind("#"+c.id+" .JCheckBox","mousedown touchstart",function(){f.ignoreMouse=!0});a.$bind("#"+c.id+" .JTextField","mousedown touchstart",function(){f.ignoreMouse=!0});a.$bind("#"+c.id+" .JTable","mousedown touchstart",function(){f.ignoreMouse=!0});a.$bind("#"+c.id+" .JScrollPane","mousedown touchstart",function(){f.ignoreMouse=!0});a.$bind("#"+c.id+" .JEditorPane","mousedown touchstart",function(){f.ignoreMouse=!0})};l.setSelected=function(c){a.$prop(c.id,
"checked",!!c.selected)};l.setSelectedIndex=function(c){a.$prop(c.id,"selectedIndex",c.selectedIndex)};l.setText=function(c){a.$prop(c.id,"value",c.text)};l.setVisible=function(c){a.$setVisible(c.id,c._visible)};l.setEnabled=function(c){a.$setEnabled(c.id,c.enabled)};l.click=function(c,b){var d=l.htDialogs[c.id];if(d){var f=d.toString();if(0<=f.indexOf("JCheck"))d.selected=c.checked;else if(0<=f.indexOf("JCombo"))d.selectedIndex=c.selectedIndex;else if(null!=d.text&&(d.text=c.value,b&&13!=(b.charCode||
b.keyCode)))return}f=l.htDialogs[a.$getAncestorDiv(c.id,"JDialog").id];f.manager.actionPerformed(d?d.name:f.registryKey+"/"+c.id)};l.setFront=function(b){var e=b.manager.vwr.html5Applet;b.zIndex!=a._getZ(e,"dialog")&&(b.zIndex=a._incrZ(e,"dialog"));b.container&&((b.container[0]||b.container).style.zIndex=b.zIndex)};l.hideMenus=function(a){if(a=a._menus)for(var b in a)a[b]._visible&&l.hideMenu(a[b])};l.windowClosing=function(b){b=l.htDialogs[a.$getAncestorDiv(b.id,"JDialog").id];b.registryKey?b.manager.processWindowClosing(b.registryKey):
b.dispose()};a._track=function(b){if(a._tracker){try{var e='<iframe style="display:none" width="0" height="0" frameborder="0" tabindex="-1" src="'+(a._tracker+"&applet="+b._jmolType+"&version="+a._version+"&appver="+a.___JmolVersion+"&url="+encodeURIComponent(document.location.href))+'"></iframe>';a.$after("body",e)}catch(d){}delete a._tracker}return b};var m;a.getProfile=function(a){if(self.Clazz&&self.JSON)return m||Clazz._startProfiling(m=0==arguments.length||a),Clazz.getProfile()};a._getInChIKey=
function(a,b){0<=b.indexOf("MOL=")&&b.split("MOL=")[1].split('"')};a._getAttr=function(a,b){var d=a.indexOf(b+"=");return 0<=d&&0<=(d=a.indexOf('"',d))?a.substring(d+1,a.indexOf('"',d+1)):null};a.User={viewUpdatedCallback:null};a.View={count:0,applets:{},sets:{}};(function(b){b.resetView=function(b,c){debugger;if(c){if(c._viewSet){var d=a.View.applets[c._viewSet];for(b in d)b!=c&&a.View.resetView(b)}}else b&&(b._reset(),a.View.updateView(b))};b.updateView=function(e,d){if(null!=e._viewSet){d||(d=
{});d.chemID||(e._searchQuery=null);d.data||(d.data="N/A");d.type=e._viewType;if(null==(e._currentView=b.__findView(e._viewSet,d)))e._currentView=b.__createViewSet(e._viewSet,d.chemID,d.viewID||d.chemID);e._currentView[d.type].data=d.data;e._currentView[d.type].smiles=e._getSmiles();a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(e,"updateView");b.__setView(e._currentView,e,!1)}};b.updateFromSync=function(e,d){e._updateMsg=d;var f=a._getAttr(d,"sourceID")||a._getAttr(d,"file");if(f){var g=
b.__findView(e._viewSet,{viewID:f});if(null==g)return a.updateView(e,d);g!=e._currentView&&b.__setView(g,e,!0);var k=(f=a._getAttr(d,"atoms"))&&0<=d.indexOf("selectionhalos ON")?eval("["+f+"]"):[];setTimeout(function(){e._currentView==g&&b.updateAtomPick(e,k)},10);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(e,"updateFromSync")}};b.updateAtomPick=function(b,c){var d=b._currentView;if(null!=d){for(var f in d)"info"!=f&&d[f].applet!=b&&d[f].applet._updateAtomPick(c);a.User.viewUpdatedCallback&&
a.User.viewUpdatedCallback(b,"updateAtomPick")}};b.dumpViews=function(a){var d=b.sets[a];if(d){var f="View set "+a+":\n";a=b.applets[a];for(var g in a)f+="\napplet "+a[g]._id+" currentView="+(a[g]._currentView?a[g]._currentView.info.viewID:null);for(g=d.length;0<=--g;){a=d[g];var f=f+("\n\n<b>view="+g+" viewID="+a.info.viewID+" chemID="+a.info.chemID+"</b>\n"),k,h;for(h in a)"info"!=h&&(f+="\nview="+g+" type="+h+" applet="+((k=a[h]).applet?k.applet._id:null)+" SMILES="+k.smiles+"\n atomMap="+JSON.stringify(k.atomMap)+
"\n data=\n"+k.data+"\n")}return f}};b.__init=function(a){var d=a._viewSet,f=b.applets;f[d]||(f[d]={});f[d][a._viewType]=a};b.__findView=function(a,d){var f=b.sets[a];null==f&&(f=b.sets[a]=[]);for(var g=f.length;0<=--g;){var k=f[g];if(d.viewID){if(k.info.viewID==d.viewID)return k}else{if(null!=d.chemID&&d.chemID==k.info.chemID)return k;for(var h in k)if("info"!=h&&(null!=d.data&&null!=k[h].data?d.data==k[h].data:d.type==h))return k}}return null};b.__createViewSet=function(e,d,f){b.count++;d={info:{chemID:d,
viewID:f||"model_"+b.count}};for(var g in a._applets)f=a._applets[g],f._viewSet==e&&(d[f._viewType]={applet:f,data:null});b.sets[e].push(d);return d};b.__setView=function(a,b,c){for(var d in a)if("info"!=d){var f=a[d],g=f.applet,k=c||null!=g&&"<modified>"==g._molData;if(!(null==g||g==b&&!k)){var h=null==f.data,l=null!=g._currentView;g._currentView=a;if(!l||!(a[d].data==f.data&&!h&!k))if(g._loadModelFromView(a),h)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(b){return a.Cache.fileCache[b]};
a.Cache.put=function(b,e){a.Cache.fileCache[b]=e};a.Cache.setDragDrop=function(b,e){a.$appEvent(b,e,"dragover",function(a){a=a.originalEvent;a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="copy"});a.$appEvent(b,e,"drop",function(d){var f=d.originalEvent;f.stopPropagation();f.preventDefault();var g=f.dataTransfer.files[0];if(null==g)try{g=""+f.dataTransfer.getData("text"),(0==g.indexOf("file:/")||0==g.indexOf("http:/")||0==g.indexOf("https:/"))&&b._scriptLoad(g)}catch(k){}else f=
new FileReader,f.onloadend=function(f){if(f.target.readyState==FileReader.DONE){var k="cache://DROP_"+g.name;f=Clazz.newByteArray(-1,f.target.result);if("console_input"==e)k=String.instantialize(f),a.$(b,e).val(0>k.indexOf("\x00")?k:f.length+" bytes");else{k.endsWith(".spt")||b._appletPanel.cacheFileByName("cache://DROP_*",!1);"JSV"==b._viewType||k.endsWith(".jdx")?a.Cache.put(k,f):b._appletPanel.cachePut(k,f);f=a._jsGetXY(b._canvas,d);var h=[null];f&&(!b._appletPanel.setStatusDragDropped||b._appletPanel.setStatusDragDropped(0,
f[0],f[1],k,h))&&b._appletPanel.openFileAsyncSpecialType(k,1,h[0])}}},f.readAsArrayBuffer(g)})}})(Jmol,jQuery);Jmol._debugCode=document&&document.location&&0<=document.location.href.indexOf("j2sdebugcode");
(function(a){a._isAsync=!1;a._asyncCallbacks={};a._coreFiles=[];var h=!1,g=[],d=[],b=0,f=[],k=[],l=function(c){arguments.length||(c=!0);delete b;for(var f;0<d.length&&"done"==(f=d[0])[4];)d.shift();if(0!=d.length)if(!a._isAsync&&!c)setTimeout(l,10);else{f.push("done");var k="JSmol exec "+f[0]._id+" "+f[3]+" "+f[2];self.System&&System.out.println(k);self.console&&console.log(k+" -- OK");g.push(k);f[1](f[0],f[2])}},m=function(b){h?l():(h=!0,LoadClazz(),b._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=
...
b._appletPanel.update(null)};c?requestAnimationFrame(f):f()}};a.loadImage=function(b,c,d,f,g,k){var h="echo_"+c+d+(f?"_"+f.length:""),l=a.getHiddenCanvas(b.vwr.html5Applet,h,0,0,!1,!0);if(null==l){if(null==k){k=new Image;if(null==f)return k.onload=function(){a.loadImage(b,c,d,null,g,k)},k.src=d,null;System.out.println("Jsmol.js Jmol.loadImage using data URI for "+h);k.src="string"==typeof f?f:"data:"+JU.Rdr.guessMimeTypeForBytes(f)+";base64,"+JU.Base64.getBase64(f)}var m=k.width,t=k.height;"webgl"==
c&&(m/=2,t/=2);l=a.getHiddenCanvas(b.vwr.html5Applet,h,m,t,!0,!1);l.imageWidth=m;l.imageHeight=t;l.id=h;l.image=k;a.setCanvasImage(l,m,t)}else System.out.println("Jsmol.js Jmol.loadImage reading cached image for "+h);return null==f?g(l,d):l};a._canvasCache={};a.getHiddenCanvas=function(b,c,d,f,g,k){c=b._id+"_"+c;b=a._canvasCache[c];if(k)return b;if(g||!b||b.width!=d||b.height!=f)b=document.createElement("canvas"),b.width=b.style.width=d,b.height=b.style.height=f,b.id=c,a._canvasCache[c]=b;return b};
...
d.debug;d.serverURL&&(a._serverUrl=d.serverURL);for(var h=!1,m=null,c=d.use.toUpperCase().split("#")[0].split(" "),e=0;e<c.length;e++){switch(c[e]){case "JAVA":h=!0;a.featureDetection.supportsJava()&&(m=new g(b,d,k));break;case "WEBGL":m=g._getCanvas(b,d,k,!0);break;case "HTML5":a.featureDetection.allowHTML5?m=g._getCanvas(b,d,k,!1):c.push("JAVA")}if(null!=m)break}null==m&&(k||!h?m={_jmolType:"none"}:h&&(m=new g(b,d)));return k?m:a._registerApplet(b,m)};g._getCanvas=function(b,d,k,h){d._isLayered=
!1;d._platform="J.awtjs2d.Platform";return h&&a.featureDetection.supportsWebGL()?(a._Canvas3D.prototype=a.GLmol.extendApplet(a._jsSetPrototype(new g(b,d,!0))),new a._Canvas3D(b,d,"Jmol",k)):!h?(a._Canvas2D.prototype=a._jsSetPrototype(new g(b,d,!0)),new a._Canvas2D(b,d,"Jmol",k)):null};g._noJavaMsg="Either you do not have Java applets enabled in your web<br />browser or your browser is blocking this applet.<br />\t\t\tCheck the warning message from your browser and/or enable Java applets in<br />\t\t\tyour web browser preferences, or install the Java Runtime Environment from <a href='http://www.java.com'>www.java.com</a>";
...
k.codePath=k.codebase+"/";if(0>k.codePath.indexOf("://")){var e=h.location.href.split("#")[0].split("?")[0].split("/");e[e.length-1]=k.codePath;k.codePath=e.join("/")}k.archive=l;k.mayscript="true";k.java_arguments="-Xmx"+Math.round(d.memoryLimit||b._memoryLimit)+"m";k.permissions=b._isSigned?"all-permissions":"sandbox";k.documentLocation=h.location.href;k.documentBase=h.location.href.split("#")[0].split("?")[0];k.jarPath=d.jarPath;a._syncedApplets.length&&(k.synccallback="Jmol._mySyncCallback");
b._startupScript&&(k.script=b._startupScript);var e="\n",j;for(j in k)k[j]&&(e+="  <param name='"+j+"' value='"+k[j]+"' />\n");e=a.featureDetection.useIEObject||a.featureDetection.useHtml4Object?"<object "+c+(a.featureDetection.useIEObject?" classid='clsid:8AD9C840-044E-11D1-B3E9-00805F499D93' codebase='http://java.sun.com/update/1.6.0/jinstall-6u22-windows-i586.cab'>":" type='application/x-java-applet'>")+e+"<p style='background-color:yellow;"+m.split('"')[1]+";text-align:center;vertical-align:middle;'>\n"+
...
progressbar:"true",progresscolor:"blue",boxbgcolor:this._color||"black",boxfgcolor:"white",boxmessage:"Downloading JmolApplet ...",script:this._color?'background "'+this._color+'"':"",code:"JmolApplet.class"};a._setAppletParams(this._availableParams,k,d);var h;d.inlineModel?(h=d.inlineModel,h=h.replace(/\r|\n|\r\n/g,0<=h.indexOf("|")?"\\/n":"|").replace(/'/g,"&#39;"),a._debugAlert&&alert("inline model:\n"+h)):h="";k.loadInline=h;k.appletReadyCallback="Jmol._readyCallback";a._syncedApplets.length&&
(k.synccallback="Jmol._mySyncCallback");k.java_arguments="-Xmx"+Math.round(d.memoryLimit||this._memoryLimit)+"m";this._initialize(d.jarPath,d.jarFile);g._createApplet(this,d,k)};d._restoreState=function(b,d){System.out.println("\n\nasynchronous restore state for "+b+" "+d);var g=this,h=g._applet&&g._applet.viewer;switch(d){case "setOptions":return function(){g.__startAppletJS(g)};case "render":return function(){setTimeout(function(){h.refresh(2)},10)};default:switch(b){case "J.shape.Balls":case "J.shape.Sticks":case "J.shape.Frank":return null}if(h&&
h.isScriptExecuting&&h.isScriptExecuting()){if(a._asyncCallbacks[b])return System.out.println("...ignored"),1;var m=h.getEvalContextAndHoldQueue(h.eval),c=m.pc-1;m.asyncID=b;a._asyncCallbacks[b]=function(a){m.pc=a;System.out.println("sc.asyncID="+m.asyncID+" sc.pc = "+m.pc);h.eval.resumeEval(m)};h.eval.pc=h.eval.pcEnd;System.out.println("setting resume for pc="+m.pc+" "+b+" to "+a._asyncCallbacks[b]+"//");return function(){System.out.println("resuming "+b+" "+a._asyncCallbacks[b]);a._asyncCallbacks[b](c)}}System.out.println(b+
"?????????????????????"+d);return function(){setTimeout(function(){h.refresh(2)},10)}}};d._notifyAudioEnded=function(a){this._applet.notifyAudioEnded(a)};d._readyCallback=function(b,d,g){if(g){a._setDestroy(this);this._ready=!0;b=this._readyScript;this._defaultModel?a._search(this,this._defaultModel,b?";"+b:""):b?this._script(b):this._src&&this._script('load "'+this._src+'"');this._showInfo(!0);this._showInfo(!1);a.Cache.setDragDrop(this,"appletdiv");this._readyFunction&&this._readyFunction(this);
...
""+Math.random();this._fileName=b;if(!this._scriptLoad(b,d)){var h=this;a._loadFileData(this,b,function(a){h.__loadModel(a,d,g)},function(){h.__loadModel(null)})}};d._scriptLoad=function(a,d){d||(d="");var g=this._isJava||!this._noscript;g&&this._script("zap;set echo middle center;echo Retrieving data...");if(!this._isSigned||null!=this._viewSet)return!1;g?this._script('load async "'+a+'";'+d):this._applet.openFile(a);this._checkDeferred("");return!0};d.__loadModel=function(b,d,g){null!=b&&(null!=
...
h._addScript=function(a,d){var b=h._scripts.length;h._scripts[b]=[a,d];return b};h._getIdForControl=function(a,d){return"string"==typeof a?a:!d||!a._canScript||a._canScript(d)?a._id:null};h._radio=function(a,d,b,f,k,l,m,c){var e=h._getIdForControl(a,d);if(null==e)return null;++h._radioCount;void 0!=l&&null!=l||(l="jmolRadioGroup"+(h._radioGroupCount-1));if(!d)return"";void 0!=m&&null!=m||(m="jmolRadio"+(h._radioCount-1));void 0!=b&&null!=b||(b=d.substring(0,32));k||(k="");a="</span>";h._actions[m]=
h._addScript(e,d);d='<span id="span_'+m+'"'+(c?' title="'+c+'"':"")+"><input name='"+l+"' id='"+m+"' type='radio' onclick='Jmol.controls._click(this);return true;' onmouseover='Jmol.controls._mouseOver(this);return true;' onmouseout='Jmol.controls._mouseOut()' "+(f?"checked='true' ":"")+h._radioCssText+" />";0<=b.toLowerCase().indexOf("<td>")&&(d+=a,a="");return d+('<label for="'+m+'">'+b+"</label>"+a+k)};h._scriptExecute=function(g,d){var b=a._applets[d[0]],f=d[1];if("object"==typeof f)f[0](g,f,
b);else"function"==typeof f?f(b):a.script(b,f)};h.__checkScript=function(a,d){var b=0<=d.value.indexOf("JSCONSOLE ")||""===a._scriptCheck(d.value);d.style.color=b?"black":"red";return b};h.__getCmd=function(a,d){if(d._cmds&&d._cmds.length){var b=d._cmds[d._cmdpt=(d._cmdpt+d._cmds.length+a)%d._cmds.length];setTimeout(function(){d.value=b},10);d._cmdadd=1;d._cmddir=a}};h._commandKeyPress=function(g,d,b){g=13==g?13:window.event?window.event.keyCode:g?g.keyCode||g.which:0;var f=document.getElementById(d),
k=a._applets[b];switch(g){case 13:return d=f.value,h._scriptExecute(f,[b,d]),f._cmds||(f._cmds=[],f._cmddir=0,f._cmdpt=-1,f._cmdadd=0),d&&0==f._cmdadd?(++f._cmdpt,f._cmds.splice(f._cmdpt,0,d),f._cmdadd=0,f._cmddir=0):f._cmdadd=0,f.value="",!1;case 27:return setTimeout(function(){f.value=""},20),!1;case 38:h.__getCmd(-1,f);break;case 40:h.__getCmd(1,f);break;default:f._cmdadd=0}setTimeout(function(){h.__checkScript(k,f)},20);return!0};h._click=function(a,d){h._element=a;1==arguments.length&&(d=h._actions[a.id]);
h._scriptExecute(a,h._scripts[d])};h._menuSelected=function(a){var d=a.value;if(void 0!=d)h._scriptExecute(a,h._scripts[d]);else{d=a.length;if("number"==typeof d)for(var b=0;b<d;++b)if(a[b].selected){h._click(a[b],a[b].value);return}alert("?Que? menu selected bug #8734")}};h._cbNotifyMaster=function(a){var d=!0,b=!0,f=!1,k,l;for(l in a.chkGroup)k=a.chkGroup[l],k.checked?b=!1:d=!1,k.indeterminate&&(f=!0);k=a.chkMaster;d?k.checked=!0:b?k.checked=!1:f=!0;k.indeterminate=f;(a=h._checkboxItems[k.id])&&
(k=a.chkMaster)&&h._cbNotifyMaster(h._checkboxMasters[k.id])};h._cbNotifyGroup=function(a,d){for(var b in a.chkGroup){var f=a.chkGroup[b];f.checked!=d&&(f.checked=d,h._cbClick(f));h._checkboxMasters[f.id]&&h._cbNotifyGroup(h._checkboxMasters[f.id],d)}};h._cbSetCheckboxGroup=function(a,d,b){var f=a;"number"==typeof f&&(f="jmolCheckbox"+f);(a=document.getElementById(f))||alert("jmolSetCheckboxGroup: master checkbox not found: "+f);var k=h._checkboxMasters[f]={};k.chkMaster=a;k.chkGroup={};"string"==
typeof d?(d=b,f=1):f=0;for(a=f;a<d.length;a++)f=d[a],"number"==typeof f&&(f="jmolCheckbox"+f),(b=document.getElementById(f))||alert("jmolSetCheckboxGroup: group checkbox not found: "+f),k.chkGroup[f]=b,h._checkboxItems[f]=k};h._cbClick=function(a){h._control=a;var d=h._actions[a.id][0],b=h._actions[a.id][1];h._click(a,a.checked?d:b);h._checkboxMasters[a.id]&&h._cbNotifyGroup(h._checkboxMasters[a.id],a.checked);h._checkboxItems[a.id]&&h._cbNotifyMaster(h._checkboxItems[a.id])};h._cbOver=function(a){var d=
h._actions[a.id][0],b=h._actions[a.id][1];window.status=h._scripts[a.checked?b:d]};h._mouseOver=function(a,d){1==arguments.length&&(d=h._actions[a.id]);window.status=h._scripts[d]};h._mouseOut=function(){window.status=" ";return!0};h._onloadResetForms=function(){h._hasResetForms||(h._hasResetForms=!0,h._previousOnloadHandler=window.onload,window.onload=function(){if(0<h._buttonCount+h._checkboxCount+h._menuCount+h._radioCount+h._radioGroupCount)for(var a=document.forms,d=a.length;0<=--d;)a[d].reset();
h._previousOnloadHandler&&h._previousOnloadHandler()})};h._getButton=function(g,d,b,f,k){g=h._getIdForControl(g,d);if(null==g)return"";void 0!=f&&null!=f||(f="jmolButton"+h._buttonCount);void 0!=b&&null!=b||(b=d.substring(0,32));++h._buttonCount;h._actions[f]=h._addScript(g,d);d='<span id="span_'+f+'"'+(k?' title="'+k+'"':"")+"><input type='button' name='"+f+"' id='"+f+"' value='"+b+"' onclick='Jmol.controls._click(this)' onmouseover='Jmol.controls._mouseOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+
h._buttonCssText+" /></span>";a._debugAlert&&alert(d);return a._documentWrite(d)};h._getCheckbox=function(g,d,b,f,k,l,m){var c=h._getIdForControl(g,d);null!=c&&(c=h._getIdForControl(g,b));if(null==c)return"";void 0!=l&&null!=l||(l="jmolCheckbox"+h._checkboxCount);++h._checkboxCount;if(void 0==d||null==d||void 0==b||null==b)alert("jmolCheckbox requires two scripts");else if(void 0==f||null==f)alert("jmolCheckbox requires a label");else return h._actions[l]=[h._addScript(c,d),h._addScript(c,b)],g="</span>",
k='<span id="span_'+l+'"'+(m?' title="'+m+'"':"")+"><input type='checkbox' name='"+l+"' id='"+l+"' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+(k?"checked='true' ":"")+h._checkboxCssText+" />",0<=f.toLowerCase().indexOf("<td>")&&(k+=g,g=""),k+='<label for="'+l+'">'+f+"</label>"+g,a._debugAlert&&alert(k),a._documentWrite(k)};h._getCommandInput=function(g,d,b,f,k,l){g=h._getIdForControl(g,"x");if(null==g)return"";
void 0!=f&&null!=f||(f="jmolCmd"+h._cmdCount);void 0!=d&&null!=d||(d="Execute");void 0!=b&&!isNaN(b)||(b=60);void 0!=l||(l="help");++h._cmdCount;d='<span id="span_'+f+'"'+(k?' title="'+k+'"':"")+"><input name='"+f+"' id='"+f+"' size='"+b+"' onkeydown='return Jmol.controls._commandKeyPress(event,\""+f+'","'+g+"\")' value='"+l+"'/><input  type='button' name='"+f+"Btn' id='"+f+"Btn' value = '"+d+"' onclick='Jmol.controls._commandKeyPress(13,\""+f+'","'+g+"\")' /></span>";a._debugAlert&&alert(d);return a._documentWrite(d)};
h._getLink=function(g,d,b,f,k){g=h._getIdForControl(g,d);if(null==g)return"";void 0!=f&&null!=f||(f="jmolLink"+h._linkCount);void 0!=b&&null!=b||(b=d.substring(0,32));++h._linkCount;d=h._addScript(g,d);b='<span id="span_'+f+'"'+(k?' title="'+k+'"':"")+"><a name='"+f+"' id='"+f+"' href='javascript:Jmol.controls._click(null,"+d+");' onmouseover='Jmol.controls._mouseOver(null,"+d+");return true;' onmouseout='Jmol.controls._mouseOut()' "+h._linkCssText+">"+b+"</a></span>";a._debugAlert&&alert(b);return a._documentWrite(b)};
h._getMenu=function(g,d,b,f,k){var l=h._getIdForControl(g,null);void 0!=f&&null!=f||(f="jmolMenu"+h._menuCount);++h._menuCount;l=typeof d;if(null!=l&&"object"==l&&d.length){var m=d.length;"number"!=typeof b||1==b?b=null:0>b&&(b=m);b='<span id="span_'+f+'"'+(k?' title="'+k+'"':"")+"><select name='"+f+"' id='"+f+"' onChange='Jmol.controls._menuSelected(this)'"+(b?" size='"+b+"' ":"")+h._menuCssText+">";for(f=0;f<m;++f){var c=d[f],l=typeof c,e=null,j=k=null;"object"==l&&null!=c?(e=c[0],k=c[1],j=c[2]):
e=k=c;l=h._getIdForControl(g,e);if(null==l)return"";null==k&&(k=e);"#optgroup"==e?b+="<optgroup label='"+k+"'>":"#optgroupEnd"==e?b+="</optgroup>":(l=h._addScript(l,e),b+="<option value='"+l+(j?"' selected='true'>":"'>")+k+"</option>")}b+="</select></span>";a._debugAlert&&alert(b);return a._documentWrite(b)}};h._getRadio=function(g,d,b,f,k,l,m,c){0==h._radioGroupCount&&++h._radioGroupCount;l||(l="jmolRadioGroup"+(h._radioGroupCount-1));g=h._radio(g,d,b,f,k,l,m?m:l+"_"+h._radioCount,c?c:0);if(null==
g)return"";a._debugAlert&&alert(g);return a._documentWrite(g)};h._getRadioGroup=function(g,d,b,f,k,l){var m=typeof d;if("object"!=m||null==m||!d.length)alert("invalid arrayOfRadioButtons");else{void 0!=b&&null!=b||(b="&#xa0; ");var c=d.length;++h._radioGroupCount;f||(f="jmolRadioGroup"+(h._radioGroupCount-1));for(var e="<span id='"+(k?k:f)+"'>",j=0;j<c;++j){j==c-1&&(b="");var s=d[j],m=typeof s,H=null,e="object"==m?e+(H=h._radio(g,s[0],s[1],s[2],b,f,3<s.length?s[3]:(k?k:f)+"_"+j,4<s.length?s[4]:0,
l)):e+(H=h._radio(g,s,null,null,b,f,(k?k:f)+"_"+j,l));if(null==H)return""}e+="</span>";a._debugAlert&&alert(e);return a._documentWrite(e)}}})(Jmol);
(function(a){var h=function(a){a="&"+a+"=";return decodeURI(("&"+document.location.search.substring(1)+a).split(a)[1].split("&")[0])};a._j2sPath=h("_J2S");a._jarFile=h("_JAR");a._use=h("_USE");a.getVersion=function(){return a._jmolInfo.version};a.getApplet=function(g,d,b){return a._Applet._get(g,d,b)};a.getJMEApplet=function(g,d,b,f){return a._JMEApplet._get(g,d,b,f)};a.getJSVApplet=function(g,d,b){return a._JSVApplet._get(g,d,b)};a.setCallback=function(a,d,b){a._setCallback(d,b)};a.loadFile=function(a,
...
a.showInfo=function(a,d){a._showInfo(d)};a.show2d=function(a,d){a._show2d(d)};a.jmolBr=function(){return a._documentWrite("<br>")};a.jmolButton=function(g,d,b,f,h){return a.controls._getButton(g,d,b,f,h)};a.jmolCheckbox=function(g,d,b,f,h,l,m){return a.controls._getCheckbox(g,d,b,f,h,l,m)};a.jmolCommandInput=function(g,d,b,f,h,l){return a.controls._getCommandInput(g,d,b,f,h,l)};a.jmolHtml=function(g){return a._documentWrite(g)};a.jmolLink=function(g,d,b,f,h){return a.controls._getLink(g,d,b,f,h)};
a.jmolMenu=function(g,d,b,f,h){return a.controls._getMenu(g,d,b,f,h)};a.jmolRadio=function(g,d,b,f,h,l,m,c){return a.controls._getRadio(g,d,b,f,h,l,m,c)};a.jmolRadioGroup=function(g,d,b,f,h,l){return a.controls._getRadioGroup(g,d,b,f,h,l)};a.setCheckboxGroup=function(g,d){a.controls._cbSetCheckboxGroup(g,d,arguments)};a.setDocument=function(g){a._document=g};a.setXHTML=function(g){a._isXHTML=!0;a._XhtmlElement=null;a._XhtmlAppendChild=!1;g&&(a._XhtmlElement=document.getElementById(g),a._XhtmlAppendChild=
...
LoadClazz=function(){TypeError.prototype.printStackTrace=ReferenceError.prototype.printStackTrace=function(){console.log(this)};window["j2s.clazzloaded"]||(window["j2s.clazzloaded"]=!1);window["j2s.clazzloaded"]||(window["j2s.clazzloaded"]=!0,window["j2s.object.native"]=!0,Clazz={_isQuiet:!1,_debugging:!1},function(a,h){try{a._debugging=0<=document.location.href.indexOf("j2sdebug")}catch(g){}var d=["j2s.clazzloaded","j2s.object.native"];a.setGlobal=function(a,b){d.push(a);window[a]=b};a.getGlobals=
...
e;try{null.hello()}catch(j){if(f=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var f=j.message.indexOf(":"),s=j.message.indexOf(":",f+2),H=j.message.substr(f+1,s-f-20);e=function(a){return-1!=a.message.indexOf(H)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var O=f(j.message,"hello");e=function(a){return O.test(a.message)}}else O=f(j.message,"$$o$$"),
...
[];for(A=0;A<d.length;A++)e[A]=d[A]instanceof a.CastedNull?null:d[A]}else e=d;d=fx.lastMethod?fx.lastMethod.apply(this,e):null}else{fx.lastParams=f.typeString;fx.lastClaxxRef=e;E=fx.stacks;E||(E=e.prototype[A].stacks);for(var h=!1,v=E.length;0<=--v;)if(h||E[v]===e){var j=E[v].prototype[A],k=f,h=d,ua=fx,l=[],I=!0,m=void 0;for(m in j)if(92==m.charCodeAt(0)){var B=m.substring(1).split("\\");B.length==k.length&&l.push(B);I=!1}else if(I&&"funParams"==m&&j.funParams){m=j.funParams;B=m.substring(1).split("\\");
B.length==k.length&&(l[0]=B);break}if(!(m=0==l.length)){for(var m=k,B=[],n=l.length,F=0;F<n;F++){for(var p=[],sa=!0,s=l[F].length,r=0;r<s;r++)if(p[r]=a.getInheritedLevel(m[r],l[F][r]),0>p[r]){sa=!1;break}sa&&(p[m.length]=F,B.push(p))}if(0==B.length)l=null;else{n=B[0];for(F=1;F<B.length;F++){p=!0;for(r=0;r<m.length;r++)if(n[r]<B[F][r]){p=!1;break}p&&(n=B[F])}l=l[n[m.length]].join("\\")}m=!l}if(m)h=new c;else{j=I?j:j["\\"+l];I=null;if(k.hasCastedNull){I=[];for(k=0;k<h.length;k++)I[k]=h[k]instanceof
a.CastedNull?null:h[k]}else I=h;ua.lastMethod=j;h=j.apply(this,I)}if(!(h instanceof c)){d=h;break a}h=!0}"construct"!=A&&V(this,e,A,f.typeString);d=void 0}}return d};j.methodName=e;j.claxxReference=d;j=h[e]=j;e=[];for(h=0;h<l.length;h++)e[h]=l[h];j.stacks=e}l=j.stacks;0>T(l,d)&&l.push(d);k&&(k.claxxOwner===d?(j[k.funParams]=k,k.claxxOwner=null,k.funParams=null):k.claxxOwner||(j["\\unknown"]=k));f.exClazz=d;j[g]=f;return j};duplicatedMethods={};var S=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||
...
else if(e=-1,c.indexOf(".z.js")==c.length-5&&-1!=(e=c.lastIndexOf("/")))for(var c=c.substring(0,e+1),e=d.split(/\./),f=1;f<e.length;f++){for(var g="/",j=0;j<f;j++)g+=e[j]+"/";if(g.length>c.length)break;if(c.indexOf(g)==c.length-g.length){c=c.substring(0,c.length-g.length+1);break}}else c=a._Loader.getClasspathFor(d,!0);else(e=a.binaryFolders)&&e.length&&(c=e[0]);c||(c="j2s/");c=c.replace(/\\/g,"/");e=c.length;e=c.charAt(e-1);"/"!=e&&(c+="/");this.base?d=c+b:(e=d.lastIndexOf("."),d=-1==e||this.base?
...
a._innerFunctions[f[s]];a._Loader=a.ClazzLoader=function(){};var n=function(){this.parents=[];this.musts=[];this.optionals=[];this.onLoaded=this.path=this.name=this.declaration=null;this.status=0;this.random=0.13412};(function(a,b){b._checkLoad=h._checkLoad;b.updateNodeForFunctionDecoration=function(a){(a=D(a))&&a.status==n.STATUS_KNOWN&&window.setTimeout(function(a){return function(){updateNode(a)}}(a),1)};n.prototype.toString=function(){return this.name||this.path||"ClazzNode"};n.STATUS_UNKNOWN=
0;n.STATUS_KNOWN=1;n.STATUS_CONTENT_LOADED=2;n.STATUS_MUSTS_LOADED=3;n.STATUS_DECLARED=4;n.STATUS_LOAD_COMPLETE=5;var c=[];b.requireLoaderByBase=function(a){for(var d=0;d<c.length;d++)if(c[d].base==a)return c[d];d=new b;d.base=a;c.push(d);return d};var d=new n,e={},f=0,g=6,j=navigator.userAgent.toLowerCase(),k=-1!=j.indexOf("opera"),l=-1!=j.indexOf("msie")&&!k,m=-1!=j.indexOf("gecko");if(k&&(g=1,k=j.indexOf("opera/"),-1!=k)){var p=9;try{p=parseFloat(j.subString(k+6))}catch(s){}9.6<=p&&(g=6)}var t;
...
Array?a=arguments[0]:null,b=a?a.length:arguments.length;if(!a)for(var a=Array(b),c=0;c<b;c++)a[c]=arguments[c];u(a);for(c=0;c<b;c++)z["@"+a[c]]=1};b.onScriptLoading=function(){};b.onScriptLoaded=function(){};b.onScriptInitialized=function(){};b.onScriptCompleted=function(){};b.onClassUnloaded=function(){};b.onGlobalLoaded=function(){};b.keepOnLoading=!0;var x={},z={},M=function(c,d,e,f){if(!f)try{eval(e+";//# sourceURL="+c)}catch(g){if(a._isQuiet)return;c="[Java2Script] The required class file \n\n"+
...
d,!1,!0,1),null;b.loadClass(c);return a.evalType(c)};a.currentPath="";var G=function(c,d,g,j,k){a.currentPath=d;j&&alert("WHY>>");j=e[d];e[d]=!0;ka(w,d);ga=!0;ha=!1;b._checkLoad&&System.out.println("\t"+d+(g?"\n -- required by "+g:"")+"  ajax="+ga+" async="+ha);g=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));j||System.out.println("loadScript "+d);b.onScriptLoading(d);if(ga&&!ha){var l=h._getFileData(d);try{M(d,g,l,j)}catch(m){alert(m+" loading file "+d+" "+c.name+" "+a.getStackTrace())}k&&k()}else c=
{dataType:"script",async:!0,type:"GET",url:d,success:L(d,!1,k),error:L(d,!0,k)},f++,j?setTimeout(c.success,0):h.$ajax(c)},L=function(c,d,e){a.getStackTrace();return function(){m&&this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<f&&f--;this.onerror=this.onload=null;d&&alert("There was a problem loading "+c);b.onScriptLoaded(c,!0);var a=this,g;g=e?function(){H(a);W(c,e)}:function(){H(a);W(c)};0<=na?window.setTimeout(function(){W(c,g)},na):W(c,g)}},K=!0,N=!1,W=
function(c,h){var j=x["@"+c];if(j){var k,m=C["$"+c];if(m)for(var q=0;q<m.length;q++){var v=m[q];if(v!=j.name&&(k=D(v)))k.status<n.STATUS_CONTENT_LOADED&&(k.status=n.STATUS_CONTENT_LOADED,updateNode(k));else{k=new n;k.name=v;var p=C["#"+v];p||(alert(v+" J2S error in tryToLoadNext"),error("Java2Script implementation error! Please report this bug!"));k.path=p;fa(k.path,v,k);k.status=n.STATUS_CONTENT_LOADED;ba(d,k,!1);updateNode(k)}}if(j instanceof Array)for(q=0;q<j.length;q++)j[q].status<n.STATUS_CONTENT_LOADED&&
...
n.STATUS_DECLARED;t&&(t[a.name]=!0);b.onScriptInitialized(a.path);if(a.declaration&&a.declaration.clazzList){h=0;j=a.declaration.clazzList;for(k=j.length;h<k;h++)if((l=D(j[h]))&&l.status!=n.STATUS_DECLARED&&l!==a)l.status=n.STATUS_DECLARED,t&&(t[l.name]=!0),b.onScriptInitialized(l.path)}}c=n.STATUS_DECLARED;if(0==a.optionals.length&&0==a.musts.length||a.status>n.STATUS_KNOWN&&!a.declaration||S(a.musts,n.STATUS_LOAD_COMPLETE)&&S(a.optionals,n.STATUS_LOAD_COMPLETE)){c=n.STATUS_LOAD_COMPLETE;if(!T(a,
...
(N&&(K=!1),N=!0));a:{if(a.name&&a!=d&&a!=b)for(e=0;e<b.parents.length;e++)if(b.parents[e].name==a.name)break a;b.parents.push(a)}},Q=function(a){var b=a.parents;if(b)for(var c=b.length;0<=--c;)ka(b[c].musts,a)||ka(b[c].optionals,a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var x=a._LoaderProgressMonitor,L=null,M=0,u=null,R=0;x.DEFAULT_OPACITY=h&&h._j2sLoadMonitorOpacity?h._j2sLoadMonitorOpacity:55;x.hideMonitor=function(){u.style.display="none"};
x.showStatus=function(a,b){if(!u){var c=document.createElement("DIV");c.id="_Loader-status";c.style.cssText="position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:"+(window["j2s.lib"].monitorZIndex||1E4)+";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";c.onmouseover=ra;u=c;document.body.appendChild(c);ca||(ca=!0)}da(u);if(null==a)b?N():x.hideMonitor();else{u.appendChild(document.createTextNode(""+a));"none"==u.style.display&&(u.style.display=
"");ea(x.DEFAULT_OPACITY);var d,c=navigator.userAgent;d=document.body;var e=d.parentNode,f=e.clientHeight;d=d.scrollTop+d.offsetTop;var g=e.scrollTop+e.offsetTop,c=0>c.indexOf("Opera")&&document.all?0==f?d:g:0>c.indexOf("Gecko")?f==e.offsetHeight&&f==e.scrollHeight?d:g:d;R!=c&&(R=c,u.style.bottom=R+4+"px");b&&N()}};var da=function(a){if(a)for(var b=a.childNodes.length;0<=--b;){var c=a.childNodes[b];if(c){c.childNodes&&c.childNodes.length&&da(c);try{a.removeChild(c)}catch(d){}}}},ea=function(a){L&&
a==x.DEFAULT_OPACITY&&(window.clearTimeout(L),L=null);M=a;navigator.userAgent.toLowerCase();u.style.filter="Alpha(Opacity="+a+")";u.style.opacity=a/100},ra=function(){x.hideMonitor()},ca=!1,N=function(){"none"!=u.style.display&&(M==x.DEFAULT_OPACITY?(L=window.setTimeout(function(){N()},750),M-=5):0<=M-10?(ea(M-10),L=window.setTimeout(function(){N()},40)):u.style.display="none")},p=a.Console,y=System;p.maxTotalLines=1E4;p.setMaxTotalLines=function(a){p.maxTotalLines=0<a?a:999999};p.maxLatency=40;p.setMaxLatency=
