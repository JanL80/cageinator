...
Clazz.load(["java.lang.Enum"], "J.c.PAL", null, function(){
var c$ = Clazz.decorateAsClass(function(){
this.$$name = null;
this.id = 0;
Clazz.instantialize(this, arguments);}, J.c, "PAL", Enum);
...
c$.PALETTE_DSSR_BASEPAIR = 8;
c$.PALETTE_AMINO = 9;
c$.PALETTE_SHAPELY = 10;
c$.PALETTE_CHAIN = 11;
c$.PALETTE_GROUP = 76;
c$.PALETTE_MONOMER = 77;
c$.PALETTE_MOLECULE = 78;
c$.PALETTE_ALTLOC = 15;
c$.PALETTE_INSERTION = 16;
c$.PALETTE_JMOL = 17;
c$.PALETTE_RASMOL = 18;
c$.PALETTE_TYPE = 19;
c$.PALETTE_ENERGY = 20;
c$.PALETTE_PROPERTY = 85;
c$.PALETTE_VARIABLE = 86;
c$.PALETTE_STRAIGHTNESS = 87;
c$.PALETTE_POLYMER = 88;
c$.PALETTE_NUCLEIC = 25;
...
Clazz.defineEnumConstant(c$, "DSSR_BASEPAIR", 9, ["basepairtype", 8]);
Clazz.defineEnumConstant(c$, "AMINO", 10, ["amino", 9]);
Clazz.defineEnumConstant(c$, "SHAPELY", 11, ["shapely", 10]);
Clazz.defineEnumConstant(c$, "CHAIN", 12, ["chain", 11]);
Clazz.defineEnumConstant(c$, "GROUP", 13, ["group", 76]);
Clazz.defineEnumConstant(c$, "MONOMER", 14, ["monomer", 77]);
Clazz.defineEnumConstant(c$, "MOLECULE", 15, ["molecule", 78]);
Clazz.defineEnumConstant(c$, "ALTLOC", 16, ["altloc", 15]);
Clazz.defineEnumConstant(c$, "INSERTION", 17, ["insertion", 16]);
Clazz.defineEnumConstant(c$, "JMOL", 18, ["jmol", 17]);
Clazz.defineEnumConstant(c$, "RASMOL", 19, ["rasmol", 18]);
Clazz.defineEnumConstant(c$, "TYPE", 20, ["type", 19]);
Clazz.defineEnumConstant(c$, "ENERGY", 21, ["energy", 20]);
Clazz.defineEnumConstant(c$, "PROPERTY", 22, ["property", 85]);
Clazz.defineEnumConstant(c$, "VARIABLE", 23, ["variable", 86]);
Clazz.defineEnumConstant(c$, "STRAIGHTNESS", 24, ["straightness", 87]);
Clazz.defineEnumConstant(c$, "POLYMER", 25, ["polymer", 88]);
Clazz.defineEnumConstant(c$, "NUCLEIC", 26, ["nucleic", 25]);
});
