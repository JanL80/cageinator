...
if (Clazz.instanceOf(this.proteinstructurePending,"JM.Helix")) {
...
} else if (Clazz.instanceOf(this.proteinstructurePending,"JM.Sheet") && Clazz.instanceOf((this.proteinstructurePending).apolymer,"JM.AminoPolymer")) {
...
this.tPending = false;
return;
}if (this.rr.renderStruts) {
this.rr.adjustStrut(segments, this.startIndexPending, this.endIndexPending, this.proteinstructurePending.monomerIndexFirst);
}this.tPending = false;
});
