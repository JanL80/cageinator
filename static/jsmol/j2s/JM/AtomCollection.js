...
Clazz.load(["JU.V3"], "JM.AtomCollection", ["java.util.ArrayList", "$.Arrays", "$.Hashtable", "JU.A4", "$.AU", "$.BS", "$.Lst", "$.M3", "$.Measure", "$.P3", "$.PT", "$.SB", "J.api.Interface", "J.atomdata.RadiusData", "J.c.PAL", "$.VDW", "JM.Group", "JS.T", "JU.BSUtil", "$.Elements", "$.Logger", "$.Parser", "$.Vibration"], function(){
...
Clazz.defineMethod(c$, "getGroupsForAtoms", 
function(bsAtoms){
var groups =  new java.util.ArrayList();
var lastGroup = null;
for (var i = bsAtoms.nextSetBit(0); i >= 0; i = bsAtoms.nextSetBit(i + 1)) {
var group = this.at[i].group;
if (group !== lastGroup) {
lastGroup = group;
groups.add(group);
}}
