...
Clazz.load(null, "JU.MeshSurface", ["JU.AU", "$.P3", "J.api.Interface", "JU.BoxInfo", "$.C", "$.GData", "$.Geodesic"], function(){
...
function(){
if (this.slicer != null) this.slicer.slabPolygons(JU.GData.getSlabObjectType(1073742333, null, false, null), false);
});
