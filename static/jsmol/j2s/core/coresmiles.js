...
var justCheckBonding = (setAromatic && (isOpenNotStrict || Clazz_instanceOf(this.target.nodes[0],"JS.SmilesAtom")));
for (var i = 3; i <= max; i++) {
...
function(){
return (this.pattern0 == null ? Clazz_superCall(this, JS.SmilesSearch, "hashCode", []) : this.pattern0.hashCode());
});
/*if3*/;(function(){
var c$ = Clazz_decorateAsClass(function(){
...
var bs = vR.get(r);
var isOK = JS.SmilesAromatic.isSp2Ring(n, jmolAtoms, bsSelected, bs, (justCheckBonding ? 3.4028235E38 : 0.1), checkExplicit, strictness == 0);
if (!isOK) continue;
bsAromatic.or(bs);
if (doCheck) {
