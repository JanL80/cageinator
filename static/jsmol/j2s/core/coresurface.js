...
Clazz_declarePackage("JS");
Clazz_load(["JS.ScriptExt"], "JS.IsoExt", ["JU.AU", "$.BS", "$.Lst", "$.M4", "$.Measure", "$.P3", "$.PT", "$.Quat", "$.SB", "$.V3", "J.api.Interface", "J.atomdata.RadiusData", "J.c.VDW", "JS.SV", "$.ScriptEval", "$.ScriptInterruption", "$.T", "JU.BSUtil", "$.BoxInfo", "$.C", "$.Escape", "$.GData", "$.Logger", "$.Parser", "$.Triangulator", "JV.JC"], function(){
...
this.vwr.plugin("NBO", "start", options);
}return;
...
case 134221834:
if (this.tokAt(i + 3) != 102409) this.invArg();
if (!this.chk) {
filename = "cache://" + this.stringParameter(i + 1);
jvxlData = this.getToken(i + 2).value.toString();
this.vwr.cachePut(filename, jvxlData);
}i += 2;
continue;
case 1228935687:
...
break;
case 102409:
filename = "cache://" + this.stringParameter(++i);
break;
}
...
if (doCache) this.setShapeProperty(iShape, (cacheAll ? "cacheAll" : "cache"), null);
...
case 1073742196:
propertyName = "width";
propertyValue = Double.$valueOf(this.floatParameter(++i));
break;
default:
...
if (doCache) this.setShapeProperty(23, (cacheAll ? "cacheAll" : "cache"), null);
...
if (i < 0) {
return JU.GData.getSlabWithinRange(i, 0);
}var eval = this.e;
var data = null;
...
return JU.GData.getSlabObjectType(tok, data, !isSlab, colorData);
}, "~N,~B");
...
var mesh0 = this.thisMesh;
for (var i = this.meshCount; --i >= 0; ) {
if (this.isomeshes[i] != null) {
var id = this.isomeshes[i].thisID;
this.setPropI("init", null, null);
this.setPropI("thisID", id, null);
this.setPropI("cache", null, null);
}}
if (mesh0 != null) {
this.setPropI("init", null, null);
this.setPropI("thisID", mesh0.thisID, null);
}return;
}if ("cache" === propertyName) {
if (this.currentMesh == null) return;
var imodel = this.currentMesh.modelIndex;
var id = this.currentMesh.thisID;
var fname = "cache://isosurface_" + id;
var jvxl = (this.getPropI("jvxlDataXml", -1));
this.vwr.cachePut(fname, jvxl.getBytes());
this.deleteMeshI(this.currentMesh.index);
this.setPropI("init", null, null);
this.setPropI("thisID", id, null);
this.setPropI("modelIndex", Integer.$valueOf(imodel), null);
this.setPropI("fileName", fname, null);
this.setPropI("readFile", null, null);
this.setPropI("finalize", "isosurface ID " + JU.PT.esc(id) + (imodel >= 0 ? " modelIndex " + imodel : "") + " /*file*/" + JU.PT.esc(fname), null);
...
Clazz_overrideMethod(c$, "setPropertySuper", 
function(propertyName, value, bs){
...
var cmd;
if (imesh == null || (cmd = imesh.scriptCommand) == null) return;
...
var id = imesh.thisID;
var jvxlID = "isosurface_" + id;
var fname = "cache://isosurface_" + id;
var o = this.vwr.fm.cacheGet(fname, false);
if (JU.AU.isAB(o)) o =  String.instantialize(o);
var jvxl = " data " + JU.PT.esc(jvxlID) + o + "end " + JU.PT.esc(jvxlID);
cmd = JU.PT.rep(cmd, "/*file*/" + JU.PT.esc(fname), jvxl);
...
return JU.GData.getSlabObjectType(1812599299,  Clazz_newArray(-1, [JU.Escape.uP(pts[0]), JU.Escape.uP(pts[1]), JU.Escape.uP(pts[2]), JU.Escape.uP(pts[3])]), isCap, null);
}var plane = JU.Escape.uP(s);
if (Clazz_instanceOf(plane,"JU.P4")) return JU.GData.getSlabObjectType(134217750, plane, isCap, null);
} catch (e) {
if (Clazz_exceptionOf(e, Exception)){
} else {
throw e;
...
if (state != null && state.indexOf("<jvxl") >= 0) state = "";
...
;//5.0.1-v7 Thu Jun 04 11:10:21 CDT 2026
Clazz_declarePackage("J.jvxl.data");
...
function(){
if ("inherit".equals(this.jvxlData.colorScheme)) {
...
if (this.colorEncoder == null && ("inherit".equals(this.jvxlData.colorScheme) || this.jvxlData.vertexColorMap == null)) return false;
if (this.jvxlData.vertexColorMap == null) {
...
Clazz_defineMethod(c$, "getDataRange", 
function(){
return ("inherit".equals(this.jvxlData.colorScheme) || this.jvxlData.jvxlPlane != null && this.colorEncoder == null ? null :  Clazz_newFloatArray(-1, [this.jvxlData.mappedDataMin, this.jvxlData.mappedDataMax, (this.jvxlData.isColorReversed ? this.jvxlData.valueMappedToBlue : this.jvxlData.valueMappedToRed), (this.jvxlData.isColorReversed ? this.jvxlData.valueMappedToRed : this.jvxlData.valueMappedToBlue)]));
});
...
;//5.0.1-v7 Thu Jun 04 11:04:18 CDT 2026
Clazz_declarePackage("J.jvxl.readers");
...
;//5.0.1-v7 Wed Jun 03 09:22:38 CDT 2026
Clazz_declarePackage("J.jvxl.readers");
Clazz_load(["JU.P3", "J.jvxl.readers.AtomDataReader", "JU.P4", "$.V3"], "J.jvxl.readers.IsoSolventReader", ["java.util.Hashtable", "JU.BS", "$.Lst", "$.Measure", "J.jvxl.data.MeshData", "JU.BSUtil", "$.GData", "$.Logger", "$.MeshSurface"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.cavityRadius = 0;
this.envelopeRadius = 0;
this.dots = null;
...
this.meshDataServer.fillMeshData(this.meshData, 3, null);
this.meshData =  new J.jvxl.data.MeshData();
}}if (this.params.thePlane != null && this.params.slabInfo == null) this.params.addSlabInfo(JU.GData.getSlabWithinRange(-100, 0));
});
...
var colorInherited = "inherit".equals(this.jvxlData.colorScheme);
...
;//5.0.1-v7 Thu Jun 04 11:22:11 CDT 2026
