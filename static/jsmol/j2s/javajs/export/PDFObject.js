...
Clazz.load(["JU.SB"], "javajs.export.PDFObject", ["java.io.ByteArrayOutputStream", "java.util.Hashtable", "java.util.zip.Deflater", "$.DeflaterOutputStream"], function(){
...
this.len = 0;
this.pt = 0;
Clazz.instantialize(this, arguments);}, javajs["export"], "PDFObject", JU.SB);
